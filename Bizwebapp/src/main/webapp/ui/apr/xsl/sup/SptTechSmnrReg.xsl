						...
						<td class="body">
							<table class="aprinnertable" width="100%">
								...
								<tr>
									...
									<td class='contant'>
										<xsl:value-of select="attnce_qty" />
									</td>
								</tr>
								<tr>
								...
								<xsl:for-each select="itemSelect01/vector/data">
									<tr>
										<td class="contant-center">
											<xsl:value-of select="msgSptTechEducAttnce001/cmpy_nm_krchar" />
										</td>
										<td class="contant-center">
											<xsl:value-of select="msgSptTechEducAttnce001/bsns_psn_regst_no" />
										</td>
										<td class="contant-right">
											<xsl:value-of select="msgSptTechEducAttnce001/reprs_psn" />
										</td>
										<td class="contant-center">
											<xsl:value-of select="msgSptTechEducAttnce001/cmpy_addr" />
										</td>
										<td class="contant-right">
											<xsl:value-of select="msgSptTechEducAttnce001/cmpy_reprs_tel" />
										</td>
										<td class="contant-right">
											<xsl:value-of select="msgSptTechEducAttnce001/attnce_nm" />
										</td>
										<td class="contant-right">
											<xsl:value-of select="msgSptTechEducAttnce001/attnce_mobile" />
										</td>
										<td class="contant-right">
											<xsl:value-of select="msgSptTechEducAttnce001/attnce_email" />
										</td>
									</tr>
								</xsl:for-each>
							</table>
