						     	...
						     	<table width="100%" class="aprinnertable">
									<tr>
										...
										<td width="15%" class="contant">
											<xsl:value-of
											select="NEWSNAPSHOT/updateInfo/apr_aply_no" />
										</td>
										<td width="11%" class="title2">신청구분</td>
										<td class="contant" colspan="5">
											<xsl:value-of
											select="NEWSNAPSHOT/updateInfo/apr_aply_clsf" />
										</td>
									</tr>
									<tr>
										...
										<td class="contant">
											<xsl:value-of
												select="NEWSNAPSHOT/updateInfo/apr_psn_krchar_nm" />
										</td>
										<td class="title2">개인번호</td>
										<td width="11%" class="contant">
											<xsl:value-of
												select="NEWSNAPSHOT/updateInfo/apr_aply_psn_no" />
										</td>
										<td width="11%" class="title2">아이디</td>
										<td width="13%" class="contant">
											<xsl:value-of
												select="NEWSNAPSHOT/updateInfo/apr_user_id" />
										</td>
										<td width="11%" class="title2">직급</td>
										<td width="20%" class="contant">
											<xsl:value-of
												select="NEWSNAPSHOT/updateInfo/apr_posi" />
										</td>
									</tr>
									<tr>
										...
										<td class="contant">
											<xsl:value-of
												select="NEWSNAPSHOT/updateInfo/apr_blong_divsn" />
										</td>
										<td class="title2">소속(부서)</td>
										<td width="15%" class="contant">
											<xsl:value-of
												select="NEWSNAPSHOT/updateInfo/apr_blong_dept" />
										</td>
										<td class="title2">소속(팀)</td>
										<td width="15%" class="contant">
											<xsl:value-of
												select="NEWSNAPSHOT/updateInfo/apr_blong_ofic" />
												<xsl:value-of select="IP" />
										</td>
										<td class="title2">연락처(HP)</td>
										<td width="18%" class="contant">
											<xsl:value-of
												select="NEWSNAPSHOT/updateInfo/apr_mobile_no" />
										</td>
									</tr>
									<tr>
										...
										<td width="80%" class="contant" colspan="7">
											<xsl:value-of
												select="NEWSNAPSHOT/updateInfo/apr_aply_resn" />
										</td>
									</tr>
									</table>
								</td>
							...
							<tr>
								<td class="body">
									<table class="aprinnertable" width="100%">
										...
										<xsl:for-each select="NEWSNAPSHOT/updateInfo/user/vector/data/msgXomBasIPAsetItemMS">
							...
							<tr>
							     <td class="body">
									<table class="aprinnertable" width="100%">
										...
										<xsl:for-each select="NEWSNAPSHOT/updateInfo/ip/vector/data/msgXomBasIPAsetItemMS">
							     	...
							     	<table width="100%" class="aprinnertable">
										<tr>
											...
											<td width="90%" class="contant">
												<xsl:for-each select="NEWSNAPSHOT/updateInfo/fileList_A/vector/data/msgXomxComAttachFileMS01">
													<a>
