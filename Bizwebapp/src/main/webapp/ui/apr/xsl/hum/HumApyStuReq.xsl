...
<xsl:stylesheet xmlns:LINS="http://www.inswave.com/LINS" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="SAVECONTROLLER">
						...
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								...
								<tr>
									...
									<td class="contant">
										<xsl:value-of select="sh_nm" />(<xsl:value-of select="sh_empno" />)
									</td>
						...
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								<tr>
									<td class='title2' width="10%">부서</td>
									<td class="contant" width="40%">
										<xsl:value-of select="rspns_dept_nm" />
									</td>
									<td class='title2' width="10%">직급</td>
									<td colspan="3" class="contant" width="40%">
										<xsl:value-of select="rspns_posi_nm" />
									</td>
								</tr>
								<tr>
									<td class='title2'>성명</td>
									<td class="contant">
										<xsl:value-of select="rspns_map_prof_nm" />
									</td>
									<td class='title2'>개인번호</td>
									<td colspan="3" class="contant">
										<xsl:value-of select="rspns_empno" />
									</td>
								</tr>
								<tr>
									<td class='title2' width="10%">부서장</td>
									<td class="contant" width="40%">
										<xsl:value-of select="rspns_depthed_nm" />
									</td>
									<td class='title2' width="10%">본부장</td>
									<td class="contant" width="40%">
										<xsl:value-of select="rspns_divsn_rspns_nm" />
									</td>
								</tr>
							</table>
						</td>
...
<!-- 									<td class='title'>입사일자</td> -->
								...
								<xsl:for-each select="HUMAPYSTULIST/vector/data/msgHumApyStu01">
									<tr>
						...
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								<tr>
									...
									<td class="contant" width="40%">
										<xsl:value-of select="format-number(ramt_amt, '#,###')"/>
									</td>
								...
								<tr>
									...
									<td colspan="3" class="contant" width="90%" style="word-break:break-all">
										<xsl:value-of select="secure_plan" />
									</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								...
								<xsl:for-each select="RSPNSPRJLIST/vector/data/msgResBgaCctmSS01">
									<tr>
										<td class="contant-center">
					...
					<tr>
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								...
								<xsl:for-each select="RSPNSSTULIST/vector/data/msgResPrjPoolingMS01">
									<tr>
										<td class="contant-center">
