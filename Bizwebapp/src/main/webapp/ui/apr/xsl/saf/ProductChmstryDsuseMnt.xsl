							...
							<table class="aprinnertable" width="100%">
								<tr>
									...
									<td width="30%" class="contant">
										<xsl:value-of select="APPROVAL/dsuse_req_no" />
									</td>

									<td width="20%" class="title2">신청자</td>
									<td width="30%" class="contant">
										<xsl:value-of select="APPROVAL/reqst_nm" />
									</td>
								...
								<tr>
									...
									<td width="30%" class="contant">
										<xsl:value-of select="substring(APPROVAL/reqst_ymd, 1, 4)" />-<xsl:value-of select="substring(APPROVAL/reqst_ymd, 5, 2)" />-<xsl:value-of select="substring(APPROVAL/reqst_ymd, 7, 2)" />
									</td>
								...
								<tr>
									...
									<td colspan="3" class="contant">
										<xsl:value-of select="APPROVAL/centr_nm" />
									</td>
								</tr>
								<tr>
							...
							<table class="aprinnertable" width="100%">
								<tr>
									...
									<td width="60%" colspan="3"  class="contant">
										<xsl:value-of select="APPROVAL/wste_exhst_ymd" />
									</td>
								</tr>
								<tr>
									<td width="20%" class="title2">폐기물 분류</td>
									<td colspan="3" class="contant">
										<xsl:value-of select="APPROVAL/wste_clsf_arr_nm" />
									</td>
								</tr>
							</table>
						</td>
					</tr>
					<xsl:if test="APPROVAL/wste_clsf_1 = 'Y'">
					<tr>
...
<!-- 									<td width="25%" class="title">폐기첨부파일</td> -->
								...
								<xsl:for-each select="APPROVAL/doc/vector/data/msgSfcDsuseReqstDetailMS01">
									<tr>
					...
					<xsl:if test="APPROVAL/wste_clsf_2 = 'Y'">
					<tr>
...
<!-- 									<td width="10%" class="title">폐기첨부파일</td> -->
								...
								<xsl:for-each select="APPROVAL/doc2/vector/data/msgSfcDsusePrductDetailMS01">
									<tr>
										<td width="10%" class="contant-center">
					...
					<tr>
						<td class="body">
							<table class="aprinnertable" width="100%">
								...
								<xsl:for-each select="APPROVAL/doc3/vector/data/msgSfcDsusePrductListMS01">
									<tr>
