									...
									<td class="body">
										<table class="aprinnertable" style="width:100%; ">
											<tr>
												...
												<td class="contant" style="width:28% ; ">
													<xsl:value-of select="intgr_mngmt_unit" />
												</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td class="contant" style="width:28% ; ">
													<xsl:value-of select="ntis_reg_no" />
												</td>
											</tr>
											<tr>
												<td class="title2" style="width:22%; ">장비명(국문)</td>
												<td class="contant" style="width:28% ; ">
													<xsl:value-of select="aset_kor_nm" />													
												</td>
												<td class="title2" style="width:22%; ">장비명(영문) </td>
												<td class="contant" style="width:28% ; ">
													<xsl:value-of select="aset_eng_nm" />
												</td>
											</tr>
											<tr>
												<td class="title2" style="width:22%; ">장비책임자</td>
												<td class="contant" style="width:28% ; ">
													<xsl:value-of select="depthed_nm" />													
												</td>
											...
											<tr>
												...
												<td class="contant" style="width:28%;" colspan="3">
													<xsl:value-of select="posi_addr" />													
												</td>
											</tr>
											<tr>
												<td class="title2" style="width:22%; ">신청지역</td>
												<td class="contant" style="width:28% ; ">
													<xsl:value-of select="req_region" />													
												</td>
										...
										<table class="aprinnertable" style="width:100%; ">
											<tr>
												...
												<td class="contant" style="width:78%;" colspan="3">
													<xsl:value-of select="enfrc_ncsst" />													
												</td>
											</tr>
											<tr>
												<td class="title2" style="width:22%; ">해당 연구시설장비의 활용성</td>
												<td class="contant" style="width:28%;" colspan="3">
													<xsl:value-of select="enfrc_use" />													
												</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td class="contant" >
													<input type='checkbox' id="chk1">
														<xsl:if test="contains(enfrc_chk, 'ACB001')">
											...
											<tr>
												...
												<td class="contant">
													<input type='checkbox' id="chk2">
														<xsl:if test="contains(enfrc_chk, 'ACB002')">
															<xsl:attribute name="checked">Y</xsl:attribute>
														</xsl:if>
													</input>											
												</td>
											...
											<tr>
												...
												<td class="contant">
													<input type='checkbox' id="chk3">
														<xsl:if test="contains(enfrc_chk, 'ACB003')">
															<xsl:attribute name="checked">Y</xsl:attribute>
														</xsl:if>
													</input>											
												</td>
											...
											<tr>
												...
												<td class="contant">
													<input type='checkbox' id="chk4">
														<xsl:if test="contains(enfrc_chk, 'ACB004')">
															<xsl:attribute name="checked">Y</xsl:attribute>
														</xsl:if>
													</input>											
												</td>
											...
											<tr>
												...
												<td class="contant">
													<input type='checkbox' id="chk5">
														<xsl:if test="contains(enfrc_chk2, 'ACB005')">
															<xsl:attribute name="checked">Y</xsl:attribute>
														</xsl:if>
													</input>											
												</td>
											...
											<tr>
												...
												<td class="contant">
													<input type='checkbox' id="chk6">
														<xsl:if test="contains(enfrc_chk, 'ACB006')">
															<xsl:attribute name="checked">Y</xsl:attribute>
														</xsl:if>
													</input>										
												</td>
											...
											<tr>
												...
												<td class="contant">
													<input type='checkbox' id="chk7">
														<xsl:if test="contains(enfrc_chk, 'ACB007')">
															<xsl:attribute name="checked">Y</xsl:attribute>
														</xsl:if>
													</input>											
												</td>
