										...
										<td class="body">
											<table class="aprinnertable" style="width:100%; ">
												<tr>
													<td class="title2" style="width:22%; ">자산구분</td>
													<td class="contant" style="width:28% ; ">
														<xsl:value-of select="APPROVAL/aset_typ_nm" />
													</td>
													<td class="title2" style="width:22% ;  ">인수인계 신청서 번호</td>
													<td id="req_no" class="contant" style="width:28% ;  ">
										...
										<td class="body">
											<table class="aprinnertable" style="width:100%; ">
												<tr>
													<td class="title2" style="width:22%; ">인계자</td>
													<td class="contant" style="width:28%; ">
														<xsl:value-of select="APPROVAL/trans_nm" />
														[
														<xsl:value-of select="APPROVAL/trans_empno" />
														]
													</td>
													<td class="title2" style="width:22%; ">이메일</td>
													<td class="contant" style="width:28%; ">
														<xsl:value-of select="APPROVAL/trans_email" />
													</td>
												</tr>
												<tr>
													<td class="title2">부서명</td>
													<td class="contant">
														<xsl:value-of select="APPROVAL/trans_dept_nm" />
													</td>
													<td class="title2">연락처</td>
													<td class="contant">
														<xsl:value-of select="APPROVAL/trans_ext_no" />
													</td>
												</tr>
												<tr>
													<td class="title2">사유</td>
													<td class="contant" colspan="3">
														<xsl:value-of select="APPROVAL/cause" />
													</td>
												</tr>
											</table>
										</td>
										...
										<td class="body">
											<table class="aprinnertable" style="width:100%; ">
												<tr>
													<td class="title2" style="width:22%; ">인수자</td>
													<td class="contant" style="width:28%; ">
														<xsl:value-of select="APPROVAL/receipt_nm" />
														[
														<xsl:value-of select="APPROVAL/receipt_empno" />
														]
													</td>
													<td class="title2" style="width:22%; ">이메일</td>
													<td class="contant" style="width:28%; ">
														<xsl:value-of select="APPROVAL/receipt_email" />
													</td>
												</tr>
												<tr>
													<td class="title2">부서명</td>
													<td class="contant">
														<xsl:value-of select="APPROVAL/receipt_dept_nm" />
													</td>
													<td class="title2">연락처</td>
													<td class="contant">
														<xsl:value-of select="APPROVAL/receipt_ext_no" />
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td colspan="4" class="body">
											<table class="aprinnertable" style="width:100%; ">
												...
												<xsl:for-each select="APPROVAL/doc1/vector/data/msgAssReceiptTransMS02">
													<tr>
														<td class="contant-center" >
									...
									<tr>
										<td colspan="4" class="body">
											<table class="aprinnertable" style="width:100%; ">
												...
												<xsl:for-each select="APPROVAL/doc2/vector/data/msgAssReceiptTransMS02">
													<tr>
