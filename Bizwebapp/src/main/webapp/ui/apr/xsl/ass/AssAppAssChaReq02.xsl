					...
					<tr>
						<td>
										...
										<table class="aprinnertable" style="width:100%; ">
											<tr>
												...
												<td class="contant" style="width:28% ; ">
													<xsl:value-of select="request/APPROVAL/aset_typ_nm" />
												</td>
									...
									<td class="body">
										<table class="aprinnertable" style="width:100%; ">
											<tr>
												...
												<td class="contant" style="width:28%; ">
													<xsl:value-of select="request/APPROVAL/trans_nm" />
													[
													<xsl:value-of select="request/APPROVAL/trans_empno" />
													]
												</td>
												<td class="title2" style="width:22%; ">이메일</td>
												<td class="contant" style="width:28%; ">
													<xsl:value-of select="request/APPROVAL/trans_email" />
												</td>
											</tr>
											<tr>
												<td class="title2">부서명</td>
												<td class="contant">
													<xsl:value-of select="request/APPROVAL/trans_dept_nm" />
												</td>
												<td class="title2">연락처</td>
												<td class="contant">
													<xsl:value-of select="request/APPROVAL/trans_ext_no" />
												</td>
											</tr>
											<tr>
												<td class="title2">사유</td>
												<td class="contant" colspan="3">
													<xsl:value-of select="request/APPROVAL/cause" />
												</td>
											</tr>
										</table>
									</td>
									...
									<td class="body">
										<table class="aprinnertable" style="width:100%; ">
											<tr>
												...
												<td class="contant" style="width:28%; ">
													<xsl:value-of select="request/APPROVAL/receipt_nm" />
													[
													<xsl:value-of select="request/APPROVAL/receipt_empno" />
													]
												</td>
												<td class="title2" style="width:22%; ">이메일</td>
												<td class="contant" style="width:28%; ">
													<xsl:value-of select="request/APPROVAL/receipt_email" />
												</td>
											</tr>
											<tr>
												<td class="title2">부서명</td>
												<td class="contant">
													<xsl:value-of select="request/APPROVAL/receipt_dept_nm" />
												</td>
												<td class="title2">연락처</td>
												<td class="contant">
													<xsl:value-of select="request/APPROVAL/receipt_ext_no" />
												</td>
											</tr>
										</table>
									</td>
								...
								<tr>
									<td colspan="4" class="body">
										<table class="aprinnertable" style="width:100%; ">
											...
											<xsl:for-each select="request/APPROVAL/doc1/vector/data/msgAssReceiptTransMS02">
												<tr>
							...
							<table class="aproutertable" style="width:100%; ">
								<tr>
									<xsl:choose>
										<xsl:when test="request/APPROVAL/chk_posi = 'Y'">
											<td colspan="4" class='head'>자산위치 정보변경 내역</td>
										</xsl:when>
										<xsl:when test="request/APPROVAL/chk_posi = 'N'">
								...
								<tr>
									<td colspan="4" class="body">
										<table class="aprinnertable" style="width:100%; ">
											...
											<xsl:for-each select="request/APPROVAL/doc2/vector/data/msgAssReceiptTransMS02">
												<tr>
