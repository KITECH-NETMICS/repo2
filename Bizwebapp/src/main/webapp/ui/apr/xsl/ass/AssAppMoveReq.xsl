					...
					<tr>
						<td>
							<table class="aproutertable" style="width:100%; ">
								<tr>
									<td colspan="4" class="head" style="width:100%; ">
										<xsl:value-of select="/ASSAPPIOREQ/ASSOUTINFO/move_clsf" />
										신청
									</td>
								</tr>
								<tr>
							...
							<table class="aproutertable" style="width:100%; ">
								<tr>
									<td colspan="4" class="head">반입정보</td>
								</tr>
								<tr>
									<td class="body">
										<table class="aprinnertable" style="width:100%; ">
											<tr>
												...
												<td colspan="3" class="contant" style="width:78%; ">
													...
													<xsl:value-of select="/ASSAPPIOREQ/ASSOUTINFO/tout_posi_build" />
													<xsl:value-of select="/ASSAPPIOREQ/ASSOUTINFO/tout_posi_floor" />
													<xsl:value-of select="/ASSAPPIOREQ/ASSOUTINFO/tout_posi_detls" />
												</td>
											</tr>
