						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="aprinnertable">
							<tr>
								...
								<td width="16%" class="contant-center">
									<xsl:value-of select="root/fspSlipHMerVo/req_psn_nm" />
								</td>
								<td class="title2">소속</td>
								<td width="16%" class="contant-center">
									<xsl:value-of select="root/fspSlipHMerVo/req_psn_dept_nm" />
								</td>
								<td class="title2">신청일자</td>
								<td width="16%" class="contant-center">
									<xsl:value-of select="root/fspSlipHMerVo/slip_tmd_pd" />
								</td>
								<td class="title2">신청번호</td>
								<td width="16%" class="contant-center">
									<xsl:value-of select="root/fspSlipHMerVo/req_no" />
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td class="body">
						<table width="100%" class="aprinnertable">
							...
							<xsl:for-each select="root/fspSlipHVoList">
								<tr>
									...
									<td class="contant-center">
										<xsl:value-of select="slip_no2" />
									</td>
									<td class="contant-center">
										<xsl:value-of select="pslip_no" />
									</td>
							...
							<tr>
								...
								<td class="contant-right"><xsl:value-of select="format-number(root/fspSlipHMerVo/totl_amt, '#,###,###,###,###,###')"/></td>
							</tr>
						</table>
					</td>
				</tr>
