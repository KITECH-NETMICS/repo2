...
<xsl:stylesheet xmlns:LINS='http://www.inswave.com/LINS' xmlns:xsl='http://www.w3.org/1999/XSL/Transform' version='1.0'>
	...
	<xsl:template match='/'>
		<body>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="aprinnertable">
							...
							<tr>
								...
								<td class='contant-center'>
									<xsl:value-of select="substring(root/slipHVo/slip_ymd,0,5)" />
									-
								...
								<td class='contant-center'>
									<xsl:if test="root/slipHVo/accnt_ymd != ''">
										<xsl:value-of select="substring(root/slipHVo/accnt_ymd,0,5)" />
										-
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aproutertable">
				<tr>
					<td class="body">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="aprinnertable">
							<tr>
								<td width="4%" class='title' rowspan='2'>
									순번
								</td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aproutertable">
				<tr>
					<td class="body">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="aprinnertable">
							<tr>
								<td width="5%" class='title' rowspan='2'>
									순번
								</td>
								<td width="15%" class='title'>
									지급방법
							...
							<xsl:for-each select="root/sendList">
								<tr>
									...
									<td class="contant-center">
										<xsl:value-of select="substring(use_ymd,0,5)" />
										-
										<xsl:value-of select="substring(use_ymd,5,2)" />
										-
										<xsl:value-of select="substring(use_ymd,7,2)" />
										<br />
									</td>
									<td class="contant-center">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aproutertable">
				<tr>
					<td class="head">회의록</td>
				</tr>
				<tr>
					<td class="body">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
							<xsl:for-each select="root/slipdList">
								<xsl:if test="meet_req_no != ''">
								<tr>
									<td class='title2' width="16%">
										회의록(
									...
									<td class='contant' width="84%">
										<a target="_blank" onclick="window.open(this.href,this.target,'width=1024,height=799, toolbar=no, menubar=no, resizable=yes');return false;">
											<xsl:attribute name="href">https://nbiz.kitech.re.kr/pop.jsp?serviceid=F241&amp;meet_req_no=<xsl:value-of select="meet_req_no" /></xsl:attribute>
											<xsl:value-of select="meet_req_no" />
										</a>
									</td>
								</tr>
								</xsl:if>
