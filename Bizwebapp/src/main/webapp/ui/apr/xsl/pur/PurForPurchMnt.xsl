			...
			<BODY>
				...
				<![CDATA[				
					...
					function openPurReqEstimPop (pPurReqNo, pCn, pSn, pBizoucode, pMaxStateCd) {
						...
						window.open("","estim82",'width=753,height=457,top=50,left=150');
					...
					/* 품목코드  */
						...
						window.open("","equipCons",'width=800,height=800,top=50,left=150');
						var frm = createForm("popFrm", "equipCons", "https://biz.kitech.re.kr/websquare/popup.html", "get");
						frm = createHidden("w2xPath", "/kitech/epu/bas/EpuBasItmGpMntA.xml", frm);
						frm = createHidden("popupID", "equipCons", frm);
						...
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								...
								<tr>
									...
									<td class="contant" colspan="2">
										<xsl:value-of select="response/select/msgPurReqMastr03/addtax_calc_rts2" />
										(
								...
								<tr>
									...
									<td class="contant" colspan="2">
										<xsl:value-of select="response/select/msgPurReqMastr03/rad_yn" />
									</td>
									<td class='title2'>RG/RI</td>
									<td class="contant" colspan="2">
										<xsl:value-of select="response/select/msgPurReqMastr03/rad_knd" />
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td class='title2' colspan='2'>연구기간외 물품도입 여부</td>
									<td class="contant" colspan='4'>
										<xsl:value-of select="response/select/msgPurReqMastr03/itm_intro_yn" />
									</td>
								</tr>
							</table>
						</td>
					...
					<tr>
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								...
								<xsl:for-each select="response/itemSelect/vector/data">
									<tr>
										...
										<td class="contant-center">
											<xsl:value-of select="msgPurReqItem/local_desc" />
										</td>
										<td class="contant-center">
										...
										<td class="contant-right">
											<xsl:value-of select="format-number(msgPurReqItem/req_time_exchgr, '#,###')" />
										</td>
										<td class="contant-right">
								...
								<tr>
									<td colspan="5" class="contant">합계</td>
									<td class="contant-right">
										<xsl:value-of select="format-number(response/select/msgPurReqMastr03/colReqAmtSum4, '#,###')" />
									</td>
						...
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								<tr>
									...
									<td class='title' width="9%">계정책임자</td>
									...
									<td class='title' width="13%">구매요청금액</td>
						...
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								<tr>
									...
									<xsl:if test="response/costCnt_C/msgPurReqCost01/cnt &gt; 0">
										<td class="contant">
											<a>
									...
									<xsl:if test="response/costCnt_D/msgPurReqCost01/cnt &gt; 0">
										<td class="contant">
											<a>
												<xsl:attribute name="href">javascript:openPurReqCostPop('<xsl:value-of select="response/select/msgPurReqMastr03/pur_req_no" />', '<xsl:value-of
													select="response/select/msgPurReqMastr03/cn" />', '<xsl:value-of select="response/select/msgPurReqMastr03/sn" />', '<xsl:value-of
