			...
			<BODY>
				...
				<![CDATA[
					...
					function openitemPop(pPurReqNo, itemOdr, addTaxRt)  {
						...
						var url = "/ui/epu/pop/EPU_POP_P349_03P.xml";
						var option = { width: 1080, height: 900, id: "EpuBasItmGpMntPop", popupName: "품목코드 검색"};
						...
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								<tr>
									...
									<td class="contant" colspan="2">
										<xsl:value-of select="root/mstrVo/req_psn_nm" />
									</td>
								</tr>
								<tr>
									<td class='title2'>사용자(정)</td>
									<td class="contant" colspan="2">
										<xsl:value-of select="root/mstrVo/user_main_nm" />
									</td>
									<td class='title2'>사용자(부)</td>
									<td class="contant" colspan="2">
										<xsl:value-of select="root/mstrVo/user_sub_nm" />
									</td>
								</tr>
								<tr>
									...
									<td class="contant" colspan="2">
										<xsl:value-of select="root/mstrVo/addtax_calc_base_cd_nm" />
										(
								...
								<tr>
									<td class='title2'>방사선장비여부</td>
									<td class="contant" colspan="2">
										<xsl:if test="root/mstrVo/rad_yn = 'Y'"> 해당</xsl:if>
										<xsl:if test="root/mstrVo/rad_yn = 'N'"> 해당안함</xsl:if>
									</td>
									<td class='title2'>RG/RI</td>
									<td class="contant" colspan="2">
										<xsl:value-of select="root/mstrVo/rad_knd" />
									</td>
								</tr>
								<tr>
									...
									<td class='title2' >연구기간외 물품도입 여부</td>
									<td class="contant" colspan="2">
										<xsl:if test="root/mstrVo/itm_intro_yn = 'Y'"> 예</xsl:if>
										<xsl:if test="root/mstrVo/itm_intro_yn = 'N'"> 아니오</xsl:if>
									</td>
								</tr>
								<tr>
									...
									<td class="contant" colspan="2">
										<xsl:value-of select="root/mstrVo/req_ymd" />
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="contant" colspan="4">
										<xsl:value-of select="root/mstrVo/instl_posi_region_cdm" />
										,
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aproutertable">
					<tr>
						<td class="head">
							<font color="red">
								외자구매요령 제4조(구매요구) 제1항 제9호에 따라, 구매요구자 및 구매요구부서장은
								구매요구 대상 물품이 안전사고 등
								<br></br>
						...
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								<tr>
									...
									<td class='title' width="8%">국내외</td>
									<td class='title' width="5%">단위</td>
									<td class='title' width="5%">수량</td>
									<td class='title' width="10%">화폐단위</td>
									<td class='title' width="10%">추정단가</td>
									<td class='title' width="7%">환율</td>
									<td class='title' width="11%">추정금액</td>
									<td class='title' width="11%">부가세</td>
									<td class='title' width="11%">합계</td>
									<!-- td class='title'>비고</td -->
								</tr>
								<xsl:variable name="req_unit_price_sum" select="sum(root/itemList/req_unit_price)" />
								<xsl:for-each select="root/itemList">
									<tr>
										...
										<td class="contant-center">
											<xsl:value-of select="local_desc" />
										</td>
										<td class="contant-center">
										...
										<td class="contant-center">
											<xsl:value-of select="curncy_unit_desc" />
										</td>
										<td class="contant-right">
										...
										<!-- td class="contant"> <xsl:value-of select="msgPurReqItem/rmk" /> </td -->
									</tr>
								</xsl:for-each>
								<tr>
									<td colspan="5" class="contant ce">합계</td>
									<td class="contant-right">
										<xsl:value-of select="format-number($req_unit_price_sum, '#,###')" />
									</td>
									<td> </td>
									<td class="contant-right">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aproutertable">
					<tr>
						<td>
							<table width="100%">
								<tr>
									<td class="head" style="width:90%;"> 계정정보</td>
