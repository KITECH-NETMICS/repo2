						...
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								<tr>
									...
									<td class="contant" colspan='3' width="58%">
								...
								<tr>
									...
									<td class="contant" colspan="5" width="86%">
						...
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								<tr>
									...
									<td class='title'>공급가액</td>
									<td class='title'>합계(원화환산)</td>
								</tr>
								<xsl:for-each select="APPROVAL/itemSelect/vector/data">
									<tr>
										...
										<td class='contant-center'>
											<xsl:value-of select="msgEpuConItem/contrct_time_curncy_unit_desc" />
										</td>
										<td class="contant-right">
											<xsl:if test="msgEpuConItem/contrct_time_exchgr_amt != ''">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
									...
									<xsl:for-each select="APPROVAL/doc2/vector/data">
										<tr>
											...
											<td class="contant-center">
												<xsl:value-of select="msgpurpayreqmastr05/unslp_no" />
											</td>
											<td class="contant">
						...
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								...
								<tr>
									<!-- TODO 컬럼 사이즈 조절 -->
									<td class='title'>계정번호</td>
									<td class='title' colspan="3">계정명</td>
									<td class='title'>계정번호</td>
									<td class='title' colspan="3">계정명</td>
								</tr>
								<tr>
								...
								<xsl:for-each select="APPROVAL/doc1/vector/data">
									<tr>
										...
										<td class="contant-right" rowspan="2">
