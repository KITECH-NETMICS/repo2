	...
	<xsl:template match="/">
		<xsl:variable name="localPath" select="request/localPath" />
			<BODY>
						...
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								...
								<tr>
									...
									<td class="contant" >
										<xsl:value-of select="selectOrd/msgEpuOrd/bid_clsf_cd" />
									</td>
									<td class='title2' width="20%">긴급입찰여부</td>
									<td class="contant">
										<xsl:value-of select="selectOrd/msgEpuOrd/emer_bid_yn" />
									</td>
								</tr>
								<tr>
								...
								<xsl:if test="selectOrd/msgEpuOrd/divYn = 'N'">
									<xsl:for-each select="selectOrd/selectAccntApr/vector/data">
										<tr>
											...
											<!-- td class="contant"> <xsl:value-of select="msgCntAccnt/accnt_cd_abbr" /> </td -->
											<!-- td class="contant-center"> <xsl:value-of select="msgCntAccnt/expns_cd" /> </td -->
											<td class="contant-center">
											...
											<!-- td class="contant"> <xsl:value-of select="format-number(msgCntAccnt/ctrl_amt, '#,###')"/> </td -->
										</tr>
									</xsl:for-each>
								</xsl:if>
								<xsl:if test="selectOrd/msgEpuOrd/divYn != 'N'">
						...
						<tr>
							<td class="body">
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
									...
									<tr>
										<td class='title2' width="20%">현장설명회여부</td>
										<td class="contant" colspan="3">
											<xsl:value-of select="selectOrd/msgEpuOrd/bidexpnyn_nm" />
										</td>
									</tr>
									<tr>
							...
							<td class="body">
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
									...
									<tr>
										...
										<td class="contant" colspan="3">
											<xsl:value-of select="selectOrd/msgEpuOrd/his_bid_yn" />
										</td>
									</tr>
									<tr>
										<td class='title2' width="20%">
				...
				<xsl:if test="selectOrd/msgEpuOrd/check_bid_succ != 'Y-PRB' | selectOrd/msgEpuOrd/group33_visible != '0'">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aproutertable">
						<tr>
							...
							<td class="body">
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
									<tr>
										...
										<td class="contant" colspan="3">
											<xsl:value-of select="selectOrd/msgEpuOrd/fitnessevaljudg" />
										</td>
									</tr>
									<tr>
										<td class='title2' width="20%">주공종</td>
										<td class="contant" style="width: 218.47px;">
											<xsl:value-of select="selectOrd/msgEpuOrd/fit_eval_maincon_cd" />
										</td>
										<td class='title2' width="20%">주공종 추정금액</td>
										<td class="contant-right">
											<xsl:if test="normalize-space(selectOrd/msgEpuOrd/fit_eval_maincon_esti_val) != ''">
												<xsl:value-of select="format-number(selectOrd/msgEpuOrd/fit_eval_maincon_esti_val, '#,###,###,###')" />
											</xsl:if>
										</td>
									</tr>
								</table>
						...
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								<tr>
									...
									<td class="contant" style="width: 218.47px;">
										<xsl:value-of select="selectOrd/msgEpuOrd/bidlimit" />
									</td>
									<td class='title2' width="20%">현장설명일시</td>
									<td class="contant">
										<xsl:if test="normalize-space(selectOrd/msgEpuOrd/bid_expl_ymd) != ''">
											<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_expl_ymd, 1, 4)" />
											-
								...
								<tr>
									...
									<td class="contant" style="width: 218.47px;">
										<xsl:value-of select="selectOrd/msgEpuOrd/filed_expn_charger" />
									</td>
									<td class='title2' width="20%">현장설명장소</td>
									<td class="contant">
										<xsl:value-of select="selectOrd/msgEpuOrd/bid_expl_loc" />
									</td>
								</tr>
								<tr>
									<td class='title2' width="20%">예산금액</td>
								...
								<tr>
									...
									<td class="contant-right" style="width: 218.47px;">
										<xsl:if test="selectOrd/msgEpuOrd/gov_supply_val_gov != ''">
											<xsl:value-of select="format-number(selectOrd/msgEpuOrd/gov_supply_val_gov, '#,###,###,###')" />
										</xsl:if>
									</td>
									<td class='title2' width="20%">
										관급금액(도급자
									...
									<td class="contant-right">
										<xsl:if test="selectOrd/msgEpuOrd/gov_supply_val_outsouce != ''">
											<xsl:value-of select="format-number(selectOrd/msgEpuOrd/gov_supply_val_outsouce, '#,###,###,###')" />
										</xsl:if>
									</td>
								</tr>
							</table>
