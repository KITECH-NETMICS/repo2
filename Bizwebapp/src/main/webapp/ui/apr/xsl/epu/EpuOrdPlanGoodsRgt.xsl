	...
	<xsl:template match="/">
		<xsl:variable name="localPath" select="request/localPath" />
			<BODY>
								...
								<tr>
									...
									<td class="body">
										<TABLE class="aprinnertable" cellspacing="0" cellpadding="0" border="0" width="100%">
											<xsl:for-each select="selectOrd/PurReqList/vector/data/msgPurDoc">
												<TR>
													<TD class="contant">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
									<tr>
										...
										<td class="contant" colspan="3">
											...
											/
											<xsl:value-of select="selectOrd/msgEpuOrd/bid_succ_method" />
										</td>
									</tr>
									<tr>
				...
				<xsl:if test="selectOrd/msgEpuOrd/group7_visible != '0'">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aproutertable">
						<tr>
							...
							<td class="body">
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
									<tr>
										...
										<td class="contant" style="width: 218.47px;">
											<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_start_ymd, 1, 4)" />-<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_start_ymd, 5, 2)" />-<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_start_ymd, 7, 2)" />
											&#160;
											<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_start_ymd, 9, 2)" />:<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_start_ymd, 11, 2)" />
										</td>
										<td class='title2' width="20%">입찰서접수마감일시</td>
										<td class="contant">
											<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_end_ymd, 1, 4)" />-<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_end_ymd, 5, 2)" />-<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_end_ymd, 7, 2)" />
											&#160;
											<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_end_ymd, 9, 2)" />:<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_end_ymd, 11, 2)" />
										</td>
									</tr>
									<tr>
										<td class='title2' width="20%">개찰(입찰)일시</td>
										<td class="contant" colspan="3">
											<xsl:value-of select="substring(selectOrd/msgEpuOrd/open_ymd, 1, 4)" />-<xsl:value-of select="substring(selectOrd/msgEpuOrd/open_ymd, 5, 2)" />-<xsl:value-of select="substring(selectOrd/msgEpuOrd/open_ymd, 7, 2)" />
											&#160;
											<xsl:value-of select="substring(selectOrd/msgEpuOrd/open_ymd, 9, 2)" />:<xsl:value-of select="substring(selectOrd/msgEpuOrd/open_ymd, 11, 2)" />
										</td>
									</tr>
									<tr>
										...
										<td class="contant" style="width: 218.47px;">
											<xsl:if test="normalize-space(selectOrd/msgEpuOrd/bid_apply_end_ymd) != ''">
												<xsl:value-of select="substring (selectOrd/msgEpuOrd/bid_apply_end_ymd, 1, 4)" />-<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_apply_end_ymd, 5, 2)" />-<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_apply_end_ymd, 7, 2)" />
												&#160;
												<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_apply_end_ymd, 9, 2)" />:<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_apply_end_ymd, 11, 2)" />
											</xsl:if>
										</td>
										<td class='title2' width="20%">
											입찰보증서<br />접수마감일시
										...
										<td class="contant">
											<xsl:if test="normalize-space(selectOrd/msgEpuOrd/bid_gurnt_fin_ymd) != ''">
												<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_gurnt_fin_ymd, 1, 4)" />-<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_gurnt_fin_ymd, 5, 2)" />-<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_gurnt_fin_ymd, 7, 2)" />
												&#160;
												<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_gurnt_fin_ymd, 9, 2)" />:<xsl:value-of select="substring(selectOrd/msgEpuOrd/bid_gurnt_fin_ymd, 11, 2)" />
											</xsl:if>
										</td>
									</tr>
									<tr>
										<td class='title2' width="20%">
											공동수급협정서<br />접수 및 구성방식
										</td>
										<td class="contant" style="width: 218.47px;">
										...
										<td class="contant">
											<xsl:if test="normalize-space(selectOrd/msgEpuOrd/join_agr_fin_ymd) != ''">
												<xsl:value-of select="substring(selectOrd/msgEpuOrd/join_agr_fin_ymd, 1, 4)" />-<xsl:value-of select="substring(selectOrd/msgEpuOrd/join_agr_fin_ymd, 5, 2)" />-<xsl:value-of select="substring(selectOrd/msgEpuOrd/join_agr_fin_ymd, 7, 2)" />
												&#160;
												<xsl:value-of select="substring(selectOrd/msgEpuOrd/join_agr_fin_ymd, 9, 2)" />:<xsl:value-of select="substring(selectOrd/msgEpuOrd/join_agr_fin_ymd, 11, 2)" />
											</xsl:if>
											<xsl:if test="normalize-space(selectOrd/msgEpuOrd/join_agr_fin_ymd) = ''">
												해당사항 없음
											</xsl:if>
									...
									<tr>
										<td class='title2' width="20%">
											동가입찰 낙찰자<br />자동추첨프로그램
										</td>
										<td class="contant" colspan="3">
											<xsl:value-of select="selectOrd/msgEpuOrd/radioSameSucLotProgramYn" />
										</td>
									</tr>
								</table>
							</td>
				...
				<xsl:if test="selectOrd/msgEpuOrd/group33_visible != '0'">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aproutertable">
						<tr>
							...
							<td class="body">
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
									...
									<tr>
										...
										<td class="contant" colspan="3">
											<xsl:value-of select="selectOrd/msgEpuOrd/itemlimityn_nm" />
										</td>
									</tr>
									<tr>
										<td class='title2' width="20%">
