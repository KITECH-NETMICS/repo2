						...
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								...
								<tr>
									...
									<td class="contant" style="width: 218.47px;"><xsl:value-of select="selectTecMas/msgEpuTecEvalMas/assist_charger_nm" /></td>
									<xsl:if test="selectTecMas/msgEpuTecEvalMas/renoti_after_yn = 'Y'">
										<td class='title2' width="20%">적합성평가 총점</td>
									</xsl:if>
									<xsl:if test="selectTecMas/msgEpuTecEvalMas/renoti_after_yn != 'Y'">
										<td class='title2' width="20%">입찰가격배점</td>
									</xsl:if>
									<td class="contant"><xsl:value-of select="selectTecMas/msgEpuTecEvalMas/bid_val_score" /></td>
								</tr>
								<tr>
									<td class='title2' width="20%">기술협상 여부</td>
							  		<td class="contant" colspan="3">
							  		<xsl:if test="selectTecMas/msgEpuTecEvalMas/tech_nego_yn_cd = 'Y'">예</xsl:if>
							  		<xsl:if test="selectTecMas/msgEpuTecEvalMas/tech_nego_yn_cd = 'N'">아니오</xsl:if>
							  		</td>
								</tr>
							</table>
						</td>							
