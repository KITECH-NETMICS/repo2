								...
								<xsl:if test="selectCnt/msgEpuConMnt/divYn != 'N'">
									<xsl:for-each select="selectCnt/selectCntAccnt/vector/data">
										<tr>
											...
											<td class="contant">
												<xsl:value-of select="msgCntAccnt/accnt_no_nm" />(<xsl:value-of select="msgCntAccnt/cls_ymd" />)
											</td>
											<td class="contant-center">
												<xsl:value-of select="msgCntAccnt/accnt_respn_psn_empnm" />
											</td>
						...
						<td class="body">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="aprinnertable">
								...
								<tr>
									...
									<xsl:if test="selectCnt/msgEpuConMnt/chng_seq_g2b != '00' ">
										<a style="color: #0000FF;">
											...
											<xsl:value-of select="selectCnt/msgEpuConMnt/contrct_no_g2b" />-<xsl:value-of select="selectCnt/msgEpuConMnt/chng_seq_g2b" />
										</a>
									</xsl:if>
									<xsl:if test="selectCnt/msgEpuConMnt/chng_seq_g2b = '00' ">
										<xsl:value-of select="selectCnt/msgEpuConMnt/contrct_no_g2b" />-<xsl:value-of select="selectCnt/msgEpuConMnt/chng_seq_g2b" />
									...
									<td class="contant">
										<a style="color: #0000FF;">
											...
											<xsl:value-of select="selectCnt/msgEpuConMnt/pur_req_no" /> 확인
										</a>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<xsl:if test="selectCnt/msgEpuConMnt/epu_tec_cnt = '' ">
										<td class="contant" style="width: 218.47px;color: #0000FF;" colspan="3">
											<xsl:value-of select="format-number(selectCnt/msgEpuConMnt/curt_con_val, '#,###,###')" />원
										</td>
									</xsl:if>
									<xsl:if test="selectCnt/msgEpuConMnt/epu_tec_cnt != '' ">
										...
										<td class="contant">
												<a style="color: #0000FF;">
												<xsl:if test="selectCnt/msgEpuConMnt/renoti_after_yn != 'Y' ">
												...
												<xsl:if test="selectCnt/msgEpuConMnt/renoti_after_yn = 'Y' ">
													<xsl:attribute name="href">javascript:openNotiNoPop('<xsl:value-of select="selectCnt/msgEpuConMnt/eval_bid_ord_no" />','<xsl:value-of select="selectCnt/msgEpuConMnt/eval_chg_no" />','<xsl:value-of select="selectCnt/msgEpuConMnt/eval_bid_noti_no_g2b" />','<xsl:value-of select="selectCnt/msgEpuConMnt/eval_chg_no_g2b" />','<xsl:value-of select="selectCnt/msgEpuConMnt/eval_clsf_cd" />')</xsl:attribute>
													<xsl:value-of select="selectCnt/msgEpuConMnt/eval_bid_ord_no" />-<xsl:value-of select="selectCnt/msgEpuConMnt/eval_chg_no" /> 확인
												</xsl:if>							
												</a>
										</td>
									</xsl:if>
								...
								<tr>
									...
									<td class="contant" style="width: 218.47px;">
										<xsl:if test="selectCnt/msgEpuConMnt/suply_time_start_ymd != '' ">
											<xsl:value-of select="substring(selectCnt/msgEpuConMnt/suply_time_start_ymd, 1, 4)" />-<xsl:value-of select="substring(selectCnt/msgEpuConMnt/suply_time_start_ymd, 5, 2)" />-<xsl:value-of select="substring(selectCnt/msgEpuConMnt/suply_time_start_ymd, 7, 2)" />
											~
											<xsl:value-of select="substring(selectCnt/msgEpuConMnt/suply_time_cls_ymd, 1, 4)" />-<xsl:value-of select="substring(selectCnt/msgEpuConMnt/suply_time_cls_ymd, 5, 2)" />-<xsl:value-of select="substring(selectCnt/msgEpuConMnt/suply_time_cls_ymd, 7, 2)" />
										</xsl:if>
									</td>
								...
								<tr>
									...
									<td class="contant" style="width: 218.47px;">
										<xsl:value-of select="substring(selectCnt/msgEpuConMnt/curt_fin_ymd, 1, 4)" />-<xsl:value-of select="substring(selectCnt/msgEpuConMnt/curt_fin_ymd, 5, 2)" />-<xsl:value-of select="substring(selectCnt/msgEpuConMnt/curt_fin_ymd, 7, 2)" />
									</td>
									<td class='title2' width="20%">인도조건</td>
									<td class="contant">납품장소 입고도</td>
								</tr>
<!-- 								<tr> -->
...
<!-- 								</tr> -->
								<tr>
									...
									<td class="contant"><xsl:value-of select="selectCnt/msgEpuConMnt/pay_way_nm" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="contant" colspan="3">
										<xsl:if test="selectCnt/msgEpuConMnt/rs_amt != '' ">
											<xsl:value-of select="format-number(selectCnt/msgEpuConMnt/rs_amt, '#,###,###')" /> 원
										</xsl:if>
									</td>
								</tr>
								<tr>
									...
									<td class="contant">
										<xsl:if test="selectCnt/msgEpuConMnt/gurnt_amt != '' ">
											<xsl:value-of select="format-number(selectCnt/msgEpuConMnt/gurnt_amt, '#,###,###')" /> 원
										</xsl:if>
									</td>
								</tr>
								<tr>
									...
									<td class="contant" colspan="3">
										<xsl:if test="selectCnt/msgEpuConMnt/contrct_base_provsn != ''">
											<xsl:value-of select="selectCnt/msgEpuConMnt/contrct_base_provsn_nm" /> (조)
										</xsl:if>
										<xsl:if test="selectCnt/msgEpuConMnt/contrct_base_provsn = ''"> 선택없음(조,항)
										</xsl:if>
									</td>
								</tr>
								<xsl:if test="selectCnt/msgEpuConMnt/contrct_base_clause != ''">
									<tr>
										<td class="contant" colspan="3">
											<xsl:value-of select="selectCnt/msgEpuConMnt/contrct_base_clause_nm" /> (항)
										</td>
									</tr>
								</xsl:if>
							</table>
