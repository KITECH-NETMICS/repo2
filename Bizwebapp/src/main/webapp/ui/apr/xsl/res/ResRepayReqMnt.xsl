    ...
    <!-- <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">  -->
      ...
      <body>
        ...
        <table class="aproutertable" width="100%">
          <tr>
            <td class="head" align='center'>연구비입금</td>
          </tr>
        </table>
        -->
        <!-- [A]문서 타이틀 (종료) -->
            ...
            <td class="body">
              ...
              <table class="aprinnertable" width="100%">
                ...
                <tr>
                  ...
                  <td width='35%'             class='contant'><xsl:value-of select="req_no/@value"/></td>
                  <td width='15%'             class='title2'>신청자</td>
                  <td width='35%'             class='contant'><xsl:value-of select="req_psn_nm/@value"/></td>
                </tr>

                <tr>
                  <td width='15%'             class='title2'>신청일자</td>
                  <td width='35%'             class='contant'><xsl:value-of select="req_ymd/@value"/></td>
                  <td width='15%'             class='title2'>부서</td>
                  <td width='35%'             class='contant'><xsl:value-of select="req_dept_nm/@value"/></td>
                </tr>
            ...
            <td class="body">
              ...
              <table class="aprinnertable" width="100%">
                ...
                <tr>
                  ...
                  <td width='20%' class='contant'><xsl:value-of select="accnt_no/@value"/></td>
                  <td width='13%' class='title2'>과제번호</td>
                  <td width='20%' class='contant'><xsl:value-of select="prj_no/@value"/></td>
                  <td width='13%' class='title2'>과제기간</td>
                  <td width='21%' class='contant'><xsl:value-of select="prj_prd_term/@value"/></td>
                </tr>

                <tr>
                  <td width='13%' class='title2'>과제명</td>
                  <td width='87%' colspan='5' class='contant'><xsl:value-of select="prj_nm/@value"/></td>
                </tr>

                <tr>
                  <td width='13%' class='title2'>과제책임자</td>
                  <td width='20%' class='contant'><xsl:value-of select="prj_rspns_nm/@value"/></td>
                  <td width='13%' class='title2'>직급</td>
                  <td width='20%' class='contant'><xsl:value-of select="posi_nm/@value"/></td>
                  <td width='13%' class='title2'>소속</td>
                  <td width='21%' class='contant'><xsl:value-of select="dept_nm/@value"/></td>
                </tr>
        ...
        <table class="aproutertable" width="100%">
          ...
          <tr>
            <td class="head">청구정보 (<xsl:value-of select="depst_odr/@value"/>)</td>
          </tr>
            ...
            <td class="body">
              ...
              <table class="aprinnertable" width="100%">
                <tr>
                  ...
                  <td width='20%'  class='contant-center'><xsl:value-of select="reschamt_clsf_nm/@value"/></td>
                  <td width='13%'  class='title2'>청구일자</td>
                  <td width='20%'  class='contant-center'><xsl:value-of select="accnt_ymd/@value"/></td>
                  <td width='13%'  class='title2'>청구계산서번호</td>
                  <td width='20%'  class='contant-center'><xsl:value-of select="bill_no/@value"/></td>
                  
                </tr>

                <tr>
                  <td width='13%'  class='title2'>청구금액</td>
                  <td width='20%'  class='contant-right'><xsl:value-of select="format-number(demnd_liq/@value, '###,###,###,##0')"/></td>
                  <td width='13%'  class='title2'>기입금액</td>
                  <td width='21%'  class='contant-right'><xsl:value-of select="format-number(collected_amt/@value, '###,###,###,##0')"/></td>   
                  <td width='13%'  class='title2'>미수잔액</td>
                  <td width='21%'  class='contant-right'><xsl:value-of select="format-number(ramt_amt/@value, '###,###,###,##0')"/></td>
                </tr>
                <tr>
                  <td width='13%'  class='title2'>입금구분</td>
                  <td width='20%'  class='contant-center'><xsl:value-of select="depst_nm/@value"/></td>
                  <td width='13%'  class='title2'>입금처</td>
                  <td width='20%'  class='contant'><xsl:value-of select="depst_loc_nm/@value"/></td>
                  <td width='13%'  class='title2'>사업자번호</td>
                  <td width='20%'  class='contant-center'><xsl:value-of select="bsns_psn_regst_no/@value"/></td>
          ...
          <tr>
            <td class="body">
              ...
              <table class="aprinnertable" width="100%">
                ...
                <tr>
                  <td class='contant-center'><xsl:value-of select="odr/@value"             /></td>  <!-- 순번          -->                
                  <td class='contant-center'><xsl:value-of select="depst_req_no/@value"    /></td>  <!-- 입금확인      -->
                  <td class='contant-right' ><xsl:value-of select="format-number(ofic_depst_amt/@value, '###,###,###,##0')"/></td>  <!-- 입금액        -->
                  <td class='contant-center'><xsl:value-of select="ofic_depst_ymd/@value"  /></td>  <!-- 입금일자      -->
                  <td class='contant'><xsl:value-of select="fin_bank_nm/@value"/> / <xsl:value-of select="bankaccnt_no/@value" /></td>  <!-- 은행/계좌번호 -->
                  <td class='contant'><xsl:value-of select="rmk/@value"   /></td>  <!-- 적요          -->
                  <td             class='contant-center'>
						<a>
							<xsl:attribute name="href">javascript:openEvidWindow('<xsl:value-of select="unslip_no/@value" />')</xsl:attribute>
							<xsl:value-of select="unslip_no/@value"/>
						</a>
                  </td>  <!-- 결의번호        -->
                </tr>
                </xsl:for-each>
                ...
                <tr>
                  ...
                  <td bgcolor='#eaeaea' class='contant-right'><xsl:value-of select="format-number(ofic_depst_amt_sum/@value, '###,###,###,##0')"/></td>  <!-- (누적)실입금액 -->
        ...
        <table class="aproutertable" width="100%">
          ...
          <xsl:if test="ATTACHFILELISTS/attach_file_lists_cnt/@value = '0'">
          <tr>
            <td class="body">
              <table class="aprinnertable" width="100%">
                <tr>
          ...
          <xsl:if test="ATTACHFILELISTS/attach_file_lists_cnt/@value = ''">
          <tr>
            <td class="body">
              <table class="aprinnertable" width="100%">
                <tr>
          ...
          <xsl:if test="format-number(ATTACHFILELISTS/attach_file_lists_cnt/@value, '##0') &gt; 0">
          <tr>
            <td class="body">
              ...
              <table class="aprinnertable" width="100%">
                ...
                <tr>
                  <td width='13%'             class='title2'>순번 : <xsl:value-of select="vector/data/msgXomxComAttachFileMS01/odr/@value"/></td>
                    ...
                    <table cellpadding="0" cellspacing="2" width="100%">
                      ...
                      <tr>
                        <td style="font-family:'돋움', Dotum, Helvetica, AppleGothic, Sans-serif; font-size:12px;">
                          <a><xsl:attribute name="href">javascript:xslFileDownload('<xsl:value-of select="attach_full_path/@value"/>/<xsl:value-of select="org_file/@value"/>')</xsl:attribute>
                             <xsl:value-of select="org_file/@value"/>
                          </a>
                        </td>
                      </tr>
                      </xsl:for-each>
