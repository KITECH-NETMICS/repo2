  ...
  <xsl:template match="APPROVALREQ">
   ...
   <body>
        ...
        <table class="aproutertable" width="100%">
          <tr>
            <td class="head" align='center'>연구비송금</td>
          </tr>
        </table>
        -->
        <!-- [A]문서 타이틀 (종료) -->
        ...
        <table class="aproutertable" width="100%">
          ...
          <tr>
            <td class="head">송금예정정보 (<xsl:value-of select="send_odr"/>)</td>
          </tr>
          ...
          <tr>
            <td class="body">
              ...
              <table class="aprinnertable" width="100%">
                ...
                <tr>
                  <td width='13%' rowspan='2' class='title2'>송금처</td>
                  <td width='20%' rowspan='2' class='contant'      ><xsl:value-of select="send_vend_nm"/></td>
                  <td width='13%'             class='title2'>송금예정총액</td>
                  <td width='20%'             class='contant-right'><xsl:value-of select="format-number(send_schdl_amt, '###,###,###,##0')"/></td>
                  <td width='13%'             class='title2'>실송금총액</td>
                  <td width='21%'             class='contant-right'><xsl:value-of select="format-number(ofic_send_amt, '###,###,###,##0')"/></td>
                </tr>

                <tr>
                  <td width='13%'             class='title2'>송금액</td>
                  <td width='20%'             class='contant-right'><xsl:value-of select="format-number(ofic_send_amt_sum, '###,###,###,##0')"/></td>
                  <td width='13%'             class='title2'>미지급잔액</td>
                  <td width='21%'             class='contant-right'><xsl:value-of select="format-number(non_payment_amt, '###,###,###,##0')"/></td>
                </tr>
            ...
            <td class="body">
              ...
              <table class="aprinnertable" width="100%">
                ...
                <tr>
                  ...
                  <td width='08%' class='title'>송금<br/>구분</td>
                  <td width='14%' class='title'>은행/<br/>계좌번호</td>
                  <td width='07%' class='title'>예금주</td>
                  <td width='12%' class='title'>금액</td>
                  <td width='10%' class='title'>송금요청<br/>일자</td>
                  <td width='07%' class='title'>내역<br/>구분</td>
                  <td width='12%' class='title'>품명</td>
                  <td width='12%' class='title'>계정/비용<br/>코드명</td>
                  <td width='07%' class='title'>통제<br/>번호</td>
                  <td width='07%' class='title'>결의<br/>번호</td>
                </tr>

                <xsl:for-each select="GRIDLIST1A/vector/data/msgResBgRemtl">
				      	<tr>
                  <td             class='contant-center'><xsl:value-of select="odr"                                             /></td>  <!-- 순번            -->
                  <td             class='contant-center'><xsl:value-of select="send_clsf_nm"                                    /></td>  <!-- 송금구분        -->
                  <td             class='contant'       ><xsl:value-of select="send_loc_bank_nm" /><br/>
                                                         <xsl:value-of select="send_loc_bankaccnt_no"                           /></td>  <!-- 은행/계좌번호   -->
                  <td             class='contant-center'><xsl:value-of select="send_loc_depstr"                                 /></td>  <!-- 예금주          -->
                  <td             class='contant-right' ><xsl:value-of select="format-number(ofic_send_amt, '###,###,###,##0')" /></td>  <!-- 금액            -->
                  <td             class='contant-center'><xsl:value-of select="ofic_send_ymd"                                   /></td>  <!-- 송금요청일자    -->
                  <td             class='contant-center'><xsl:value-of select="detls_clsf_equip_nm"                             /></td>  <!-- 내역구분        -->
                  <td             class='contant'       ><xsl:value-of select="gdnm"                                            /></td>  <!-- 품명            -->
                  <td             class='contant'       ><xsl:value-of select="accnt_cd_nm" />/
                                                         <xsl:value-of select="expns_cd_nm"                                     /></td>  <!-- 계정/비용코드명 -->
                  <td             class='contant-center'><xsl:value-of select="ctrl_no"                                         /></td>  <!-- 통제번호        -->
                ...
                <tr>
                  ...
                  <td bgcolor='#eaeaea'       class='contant-right'><xsl:value-of select="format-number(ofic_send_amt_sum, '###,###,###,##0')"/></td>  <!-- (누적)실송금금액 -->
                  <td             colspan='6' class='title'        ></td>                                                                                     <!-- Blank            -->
                </tr>
