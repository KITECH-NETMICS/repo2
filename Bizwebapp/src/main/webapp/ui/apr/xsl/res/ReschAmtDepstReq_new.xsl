            ...
            <td class="body">
              <table class="aprinnertable" width="100%">
                <tr>
                  ...
                  <td width='35%'  class='contant'><xsl:value-of select="root/recVo/req_no"/></td>
                  <td width='15%'  class='title2'>신청자</td>
                  <td width='35%'  class='contant'><xsl:value-of select="root/recVo/req_psn_nm"/></td>
                </tr>

                <tr>
                  <td width='15%'  class='title2'>신청일자</td>
                  <td width='35%'  class='contant'><xsl:value-of select="root/recVo/req_ymd"/></td>
                  <td width='15%'  class='title2'>부서</td>
                  <td width='35%'  class='contant'><xsl:value-of select="root/recVo/req_dept_nm"/></td>
                </tr>
            ...
            <td class="body">
              ...
              <table class="aprinnertable" width="100%">
                ...
                <tr>
                  ...
                  <td width='20%' class='contant'><xsl:value-of select="root/recVo/reschamt_clsf_nm"/></td>
                  <td width='13%' class='title2'>입금예정총액</td>
                  <td width='20%' class='contant-right'><xsl:value-of select="format-number(root/recVo/depst_schdl_amt, '###,###,###,##0')"/></td>
                  <td width='13%' class='title2'>실입금총액</td>
                  <td width='21%' class='contant-right'><xsl:value-of select="format-number(root/recVo/ofic_depst_amt, '###,###,###,##0')"/></td>
                </tr>

                <tr>
                  <td width='13%' class='title2'>입금처</td>
                  <td width='20%' class='contant'      ><xsl:value-of select="root/recVo/depst_loc_nm"/></td>
                  <td width='13%' class='title2'>입금액</td>
                  <td width='20%' class='contant-right'><xsl:value-of select="format-number(root/recVo/ofic_depst_amt_sum, '###,###,###,##0')"/></td>
                  <td width='13%' class='title2'>미수잔액</td>
                  <td width='21%' class='contant-right'><xsl:value-of select="format-number(root/recVo/uncollected_amt, '###,###,###,##0')"/></td>
                </tr>
                <tr>
                  <td width='13%' class='title2'>입금구분</td>
                  <td width='20%' class='contant' ><xsl:value-of select="root/recVo/depst_clsf_nm"/></td>
                  <td width='13%' class='title2'></td>
                  <td width='20%' class='contant-right'></td>
                  <td width='13%' class='title2'></td>
            ...
            <td class="body">
              <table class="aprinnertable" width="100%">
                <tr>
                  ...
                  <td width='08%' class='title'>입금구분</td>
                  <td width='11%' class='title'>어음번호</td>
                  <td width='11%' class='title'>계산서</td>
                  <td width='11%' class='title'>입금확인</td>
                  <td width='12%' class='title'>입금액</td>
                  <td width='10%' class='title'>입금일자</td>
                  <td width='15%' class='title'>은행/계좌번호</td>
                ...
                <xsl:for-each select="root/rectlList">
	                <tr>
	                  ...
	                  <td class='contant-center'><xsl:value-of select="depst_clsf" /></td>  <!-- 입금구분      -->
	                  <td class='contant'       ><xsl:value-of select="prmsnt_no" /></td>  <!-- 어음번호      -->
	                  <td class='contant-center'><xsl:value-of select="recv_bill_no" /></td>  <!-- 계산서        -->
	                  ...
	                  <td class='contant-center'>
	                  	<xsl:value-of select="substring(ofic_depst_ymd, 1, 4)" />
						-
						<xsl:value-of select="substring(ofic_depst_ymd, 5, 2)" />
						-
						<xsl:value-of select="substring(ofic_depst_ymd, 7, 2)" />
	                  </td>  <!-- 입금일자      -->
	                  <td class='contant'><xsl:value-of select="bank_nm"/><br/>
	                                      <xsl:value-of select="bankaccnt_no"/></td>  <!-- 은행/계좌번호 -->
