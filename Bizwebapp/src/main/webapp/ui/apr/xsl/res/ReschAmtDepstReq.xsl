            ...
            <td class="body">
              ...
              <table class="aprinnertable" width="100%">
                ...
                <tr>
                  ...
                  <td width='20%'             class='contant-right'><xsl:value-of select="format-number(depst_schdl_amt, '###,###,###,##0')"/></td>
                  <td width='13%'             class='title2'>실입금총액</td>
                  <td width='21%'             class='contant-right'><xsl:value-of select="format-number(ofic_depst_amt, '###,###,###,##0')"/></td>
                </tr>
                ...
                <tr>
                  ...
                  <td width='21%'             class='contant-right'><xsl:value-of select="format-number(uncollected_amt, '###,###,###,##0')"/></td>
                </tr>
                <tr>
                  <td width='13%'             class='title2'>입금구분</td>
                  <td width='20%'             class='contant' ><xsl:value-of select="depst_nm"/></td>
            ...
            <td class="body">
              ...
              <table class="aprinnertable" width="100%">
                ...
                <tr>
                  ...
                  <td             class='contant'       ><xsl:value-of select="fin_bank_nm"/><br/>
