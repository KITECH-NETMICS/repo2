			...
			<body>
								...
								<tr>
									<td width="100%">
										<font color='#FF0000' face='굴림'>
											<b> <xsl:value-of select="root/infoVo/drctText" /> </b>
										</font>
									</td>
								</tr>
								...
								<tr>
									...
									<td width='80%' align='right'>
										<font color='#444444' face='굴림'>
											<b>
												신청번호 :
												<xsl:value-of select="root/infoVo/req_no" />
											</b>
										</font>
									</td>
								</tr>
							...
							<table class="aprinnertable" width="100%">
								<tr>
									...
									<td width='20%' class='contant'>
										<xsl:value-of select="root/infoVo/accnt_no" />
									</td>
									<td width='13%' class='title2'>과제기간</td>
									<td width='20%' class='contant'>
										<xsl:value-of select="root/infoVo/resch_prd_term" />
									</td>
									<td width='13%' class='title2'>계정상태</td>
									<td width='21%' class='contant'>
										<xsl:value-of select="root/infoVo/accnt_state_nm" />
									</td>
								</tr>
								<tr>
									<td width='13%' class='title2'>계정구분</td>
									<td width='20%' class='contant'>
										<xsl:value-of select="root/infoVo/accnt_clsf_nm" />
									</td>
									<td width='13%' class='title2'>사업구분</td>
									<td width='54%' colspan='3' class='contant'>
										<xsl:value-of select="root/infoVo/bsns_cd_bsns_nm" />
									</td>
								</tr>
								<tr>
									<td width='13%' class='title2'>과제명</td>
									<td width='87%' colspan='5' class='contant'>
										<xsl:value-of select="root/infoVo/prj_nm" />
									</td>
								</tr>
								<tr>
									<td width='13%' class='title2'>연구책임자</td>
									<td width='20%' class='contant'>
										<xsl:value-of select="root/infoVo/resch_rspns_str" />
									</td>
									<td width='13%' class='title2'>직급</td>
									<td width='20%' class='contant'>
										<xsl:value-of select="root/infoVo/curr_posi_nm" />
									</td>
									<td width='13%' class='title2'>소속</td>
									<td width='21%' class='contant'>
										<xsl:value-of select="root/infoVo/curr_dept_nm" />
									</td>
								</tr>
								<tr>
									<td width='13%' class='title2'>계정책임자</td>
									<td width='20%' class='contant'>
										<xsl:value-of select="root/infoVo/accnt_rspns_str" />
									</td>
									<td width='13%' class='title2'>직급</td>
									<td width='20%' class='contant'>
										<xsl:value-of select="root/infoVo/posi_nm" />
									</td>
									<td width='13%' class='title2'>소속</td>
									<td width='21%' class='contant'>
										<xsl:value-of select="root/infoVo/dept_nm" />
									</td>
								</tr>
						...
						<tr>
							<td align='right'>
								<font color='#444444' face='굴림'>
									<b>
										간접비 :
										<xsl:value-of select="root/infoVo/indicost_rt_inp" />
									</b>
									<b>
										간접비 편성액 :
										<xsl:value-of select="root/infoVo/indicost_amt" />
									</b>
								</font>
							</td>
						</tr>
				...
				<table class="aproutertable" width="100%">
					<tr>
						<td class="head">
							실행예산정보 (
							<xsl:value-of select="root/infoVo/apr_exec_bugt_seq" />
							)
						</td>
					</tr>
					<tr>
							...
							<table class="aprinnertable" width="100%">
								<tr>
							 	...
							 	<xsl:for-each select="root/detailList">
									...
									<xsl:variable name="itmClsfNmPrev" select="preceding::detailList[1]/itm_clsf_nm" /> <!-- 이전노드의 대비목  -->
									...
									<xsl:if test="$itmClsfNm != $itmClsfNmPrev"> 
										<tr>
											...
											<td width='11%' class='contant-right'>
												<xsl:value-of select="format-number(sum(../detailList[itm_clsf_nm = $itmClsfNmPrev]/bg_agree_tot_sum), '#,##0')" />
											</td>  <!-- (소계)협약예산 -->
											
											<td width='10%' class='contant-right'>
												<xsl:value-of select="format-number(sum(../detailList[itm_clsf_nm = $itmClsfNmPrev]/pre_amt)               , '#,##0')" />
											</td>  <!-- (소계)이전실행예산 -->
											
											<td width='10%' class='contant-right'>
												<xsl:value-of select="format-number(sum(../detailList[itm_clsf_nm = $itmClsfNmPrev]/amt)                     , '#,##0')" />
											</td>  <!-- (소계)실행예산 -->
											
											<td width='10%' class='contant-right'>
												<xsl:value-of select="format-number(sum(../detailList[itm_clsf_nm = $itmClsfNmPrev]/enfrc_cause_amt) , '#,##0')" />
									...
									<xsl:if test="position()=last()"> 
										<tr>
											...
											<td width='11%' class='contant-right'>
												<xsl:value-of select="format-number(sum(../detailList[itm_clsf_nm = $itmClsfNm]/bg_agree_tot_sum), '#,##0')" />
											</td>  <!-- (소계)협약예산 -->
										
											<td width='10%' class='contant-right'>
												<xsl:value-of select="format-number(sum(../detailList[itm_clsf_nm = $itmClsfNm]/pre_amt)               , '#,##0')" />
											</td>  <!-- (소계)이전실행예산 -->
										
											<td width='10%' class='contant-right'>
												<xsl:value-of select="format-number(sum(../detailList[itm_clsf_nm = $itmClsfNm]/amt)                      , '#,##0')" />
											</td>  <!-- (소계)실행예산 -->
										
											<td width='10%' class='contant-right'>
												<xsl:value-of select="format-number(sum(../detailList[itm_clsf_nm = $itmClsfNm]/enfrc_cause_amt) , '#,##0')" />
											</td>  <!-- (소계)집행금액<br/>(원인금액포함) -->
										</tr>
									</xsl:if>
								</xsl:for-each> 
								<tr>
									...
									<td width='11%' class='contant-right'>
										<xsl:value-of select="format-number(root/infoVo/tot_bg_agree_tot_sum, '#,##0')" />
									</td>  <!-- (합계)협약예산 -->
									
									<td width='10%' class='contant-right'>
										<xsl:value-of select="format-number(root/infoVo/tot_pre_amt                , '#,##0')" />
									</td>  <!-- (합계)실행예산 -->
									
									<td width='10%' class='contant-right'>
										<xsl:value-of select="format-number(root/infoVo/tot_amt                       , '#,##0')" />
									</td>  <!-- (합계)실행예산 -->
									
									<td width='10%' class='contant-right'>
										<xsl:value-of select="format-number(root/infoVo/tot_enfrc_cause_amt   , '#,##0')" />
							...
							<table class="aprinnertable" width="100%">
								<tr>
									...
									<td width='87%' class='contant'>
										<xsl:value-of select="root/infoVo/resn_contnt" />
									</td>
								</tr>
							</table>
						</td>
