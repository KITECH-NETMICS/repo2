                            ...
                            <td class="body">
                                <table class="aprinnertable" style="width:100%; " >  
                                    <tr>
                                        ...
                                        <td class="contant" style="width:28% ;  " ><xsl:value-of select = "root/req_no"/></td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td colspan="4" class="body">               
                                <table class="aprinnertable" style="width:100%; ">                     
                                    ...
                                    <xsl:for-each select="root/aprGrid01">
                                    <tr>
                            ...
                            <td class="body">
                                <table class="aprinnertable" style="width:100%; ">  
                                    <tr>
                                        ...
                                        <td colspan="3" class="contant"><xsl:value-of select = "root/req_ymd"/></td>
                                    </tr>
                                    <tr>
                                        <td class="title2" style="width:22%;" >신청자</td>
                                        <td class="contant" style="width:28%;"><xsl:value-of select = "root/req_nm"/></td>
                                        <td class="title2" style="width:22%;" >부서명</td>
                                        <td class="contant" style="width:28%;"><xsl:value-of select = "root/req_dept_nm"/></td>
                                    </tr>  
                                    <tr>
                                        <td class="title2" style="width:22%;" >신청사유</td>
                                        <td colspan="3" class="contant" style="width:28%;"><xsl:value-of select = "root/req_resn"/></td>                           
                                    </tr>
                                    <tr>
