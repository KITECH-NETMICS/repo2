        	            ...
        	            <tr>
        	                <td class="body">
        	                    <table class="aprinnertable" style="width:100%; " >  
        	                        ...
        	                        <xsl:for-each select="/PATIPDCRT/DRAFTINFO/smitList/vector/data/smitLst01">
									<tr>
        	                            <td class="contant"><xsl:value-of select="req_no" /></td>
        	                            <td class="contant"><xsl:value-of select = "mngmt_no"/></td>
        	                            <td class="contant"><xsl:value-of select = "invnt_krn_nm"/></td>
        	                            <td class="contant"><xsl:value-of select = "invnt_nm"/></td>
        	                            <td class="contant"><xsl:value-of select = "smitapp_no"/></td>
        	                            <td class="contant"><xsl:value-of select = "smitapp_ymd"/></td>
        	                        </tr>		
									</xsl:for-each>	
        	                    </table>
        	                </td>
        	                ...
        	                <td class="body">
        	                    <table class="aprinnertable" style="width:100%; ">  
        	                        <tr>
        	                            ...
        	                            <td class="contant" colspan="3" style="width:72%; "><xsl:value-of select = "/PATIPDCRT/DRAFTINFO/dp_clsf_nm"/></td>
         	                        </tr>        	                        
        	                        <tr>
        	                            <td class="title2">사유</td>
        	                            <td class="contant" colspan="3" ><xsl:value-of select = "/PATIPDCRT/DRAFTINFO/dp_resn"/></td>
        	                        </tr>  
        	                        <tr>
									<td class='title2'>첨부파일</td>
									<td class='contant' colspan = '3' >
										<xsl:for-each select="/PATIPDCRT/DRAFTINFO/fileList_A/vector/data/mdata">
											<a>
