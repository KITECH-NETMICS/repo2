...
<%@page import="kr.re.kitech.biz.zam.vo.*"%>
...
<div id="content_pop">
	...
	<div id="title">
		<ul>
			<li><img src="<c:url value='/cm/images/zam/rte/title_dot.gif'/>"> 사원정보 <c:out value="${registerFlag}"/></li>
		</ul>
	</div>
		...
		<tr>
			...
			<td class="tbtd_content" width ='300'>
				<c:if test="${empFileVo.fileName != null}">
					...
					<span class="btn_blue_l"><a href="javascript:fn_delete_file();">파일삭제</a><img src="<c:url value='/cm/images/zam/rte/btn_bg_r.gif'/>" style="margin-left:6px;"></span>
				</c:if>					
			</td>
		</tr>	
	...
	<div id="sysbtn">
		<ul>
			<li><span class="btn_blue_l"><a href="javascript:fn_emp_selectList();">List</a><img src="<c:url value='/cm/images/zam/rte/btn_bg_r.gif'/>" style="margin-left:6px;"></span></li>
			<li><span class="btn_blue_l_<%=com.inswave.elfw.util.AdminAuth.getAdminAuth(elHeader.getAuth())%>"><a href="javascript:fn_emp_save();"><c:out value='${registerFlag}'/></a><img src="<c:url value='/cm/images/zam/rte/btn_bg_r.gif'/>" style="margin-left:6px;"></span></li>
			<c:if test="${registerFlag == '수정'}">
			<li><span class="btn_blue_l_<%=com.inswave.elfw.util.AdminAuth.getAdminAuth(elHeader.getAuth())%>"><a href="javascript:fn_emp_delete();">삭제</a><img src="<c:url value='/cm/images/zam/rte/btn_bg_r.gif'/>" style="margin-left:6px;"></span></li>
			</c:if>
			<li><span class="btn_blue_l_<%=com.inswave.elfw.util.AdminAuth.getAdminAuth(elHeader.getAuth())%>"><a href="javascript:fn_reset();">Reset</a><img src="<c:url value='/cm/images/zam/rte/btn_bg_r.gif'/>" style="margin-left:6px;"></span></li></ul>
	</div>
</div>
