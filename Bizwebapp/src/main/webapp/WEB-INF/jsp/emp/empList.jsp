...
<div id="content_pop">
	...
	<div id="title">					
		<table width="100%" border="0" cellpadding="0" cellspacing="0">		  
			<tr>
				<td class="title_l">
					<img src="<c:url value='/cm/images/zam/rte/title_dot.gif'/>"> 사원 List
				</td>							
				<td class="title_r">
		...
		<table class="search_table" width="100%" border="0" cellpadding="0" cellspacing="0">  
			<tr>
				...
				<td class="search_r" width='45'>
				    <span class="btn_blue_l"><a href="javascript:fn_egov_selectList();"><spring:message code="button.search" /></a><img src="<c:url value='/cm/images/zam/rte/btn_bg_r.gif'/>" style="margin-left:6px;"></span>
				</td>
			</tr>
		</table>				 	
	</div>
	...
	<!-- /List -->
	<div id="paging">
	    <%=new kr.re.kitech.biz.xom.base.BizWebPageRenderer(new kr.re.kitech.biz.xom.base.BizPageLabelInfo()).getPageRenderer(empVo)%>
		<input type='hidden' name="pageIndex" value="${empVo.pageIndex}" />
	</div>
	<div id="sysbtn1">
		<ul>
		<div id="sysbtn"><ul>
		<li><span class="btn_blue_l_<%=com.inswave.elfw.util.AdminAuth.getAdminAuth(elHeader.getAuth()) %>"><a href="javascript:fn_egov_addView();">등록</a><img src="<c:url value='/cm/images/zam/rte/btn_bg_r.gif'/>" style="margin-left:6px;"></span></li></ul>
		</div>
		</ul>
	</div>
</div>
