...
<div id="content_pop">
	...
	<div id="title">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">		  
			<tr>
				<td class="title_l">
					<img src="<c:url value='/cm/images/zam/rte/title_dot.gif'/>"> EL Demo 로그인
				</td>							
				<td class="title_r">
		...
		<table class="search_table" width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td class="search_r" width='150'>
					<span class="btn_blue_l"><a href="javascript:loginSubmit();">로그인</a><img src="<c:url value='/cm/images/zam/rte/btn_bg_r.gif'/>" style="margin-left:6px;"></span>			    
				</td>
			</tr>
		</table>
	</div>	
