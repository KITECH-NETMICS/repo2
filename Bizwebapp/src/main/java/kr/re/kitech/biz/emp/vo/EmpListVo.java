package kr.re.kitech.biz.emp.vo;
...
public class EmpListVo extends kr.re.kitech.biz.cmmn.BizCommVO {
    ...
    private java.util.List<kr.re.kitech.biz.emp.vo.EmpVo> empVoList;
    ...
    private java.util.List<kr.re.kitech.biz.emp.vo.DeptVo> deptVoList;
    ...
    private kr.re.kitech.biz.emp.vo.EmpVo empVo;

    public int getEmpCnt(){
        return empVoList != null ? empVoList.size() : 0 ;
    }

    public java.util.List<kr.re.kitech.biz.emp.vo.EmpVo> getEmpVoList(){
        return empVoList;
    }

    public void setEmpVoList(java.util.List<kr.re.kitech.biz.emp.vo.EmpVo> empVoList){
        this.empVoList = empVoList;
    }

    public java.util.List<kr.re.kitech.biz.emp.vo.DeptVo> getDeptVoList(){
        return deptVoList;
    }

    public void setDeptVoList(java.util.List<kr.re.kitech.biz.emp.vo.DeptVo> deptVoList){
        this.deptVoList = deptVoList;
    }

    public kr.re.kitech.biz.emp.vo.EmpVo getEmpVo(){
        return empVo;
    }

    public void setEmpVo(kr.re.kitech.biz.emp.vo.EmpVo empVo){
        this.empVo = empVo;
    }
	...
	public byte[] marshalFld(String encode) throws Exception{
        ...
        try {
            ...
            for( int i=0 ; empVoList != null && i < empVoList.size() ; i++ ) {
                kr.re.kitech.biz.emp.vo.EmpVo vo = (kr.re.kitech.biz.emp.vo.EmpVo)empVoList.get(i);
    ...
    public void unMarshalFld( byte[] bytes , String encode) throws Exception{
        try{ 
             ...
             {
                 java.util.List<kr.re.kitech.biz.emp.vo.EmpVo> alList = new java.util.ArrayList<kr.re.kitech.biz.emp.vo.EmpVo>();
                 for( int i=0 ; i < empCnt ; i++ ) {
                     kr.re.kitech.biz.emp.vo.EmpVo vo = new kr.re.kitech.biz.emp.vo.EmpVo(_offset);
    ...
    public void _xStreamEnc() {
        ...
        for( int i=0 ; deptVoList != null && i < deptVoList.size() ; i++ ) {
            kr.re.kitech.biz.emp.vo.DeptVo vo = (kr.re.kitech.biz.emp.vo.DeptVo)deptVoList.get(i);
            vo._xStreamEnc();	 
        }
