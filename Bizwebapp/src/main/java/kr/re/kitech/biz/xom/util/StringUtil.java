...
public class StringUtil {
    ...
    /**
     * 입력된 String 문자열이 null인지 체크한다. 만일 null인 경우 RuntimeException을 던진다.
     * 
     * <pre>
    ...
    private static void checkIsNull(String string) {
        if (string == null) {
            throw new RuntimeException("StringUtil_NULL_EXCEPTION_E");
        }
    }

    /**
     * 입력된 StringBuffer 문자열이 null인지 체크한다. 만일 null인 경우 RuntimeException을 던진다.
     * 
     * <pre>
    ...
    /**
     * 입력된 문자열 배열이 null인지 체크한다. 만일 null인 경우 RuntimeException을 던진다.
     * 
     * <pre>
     * StringUtil.checkIsNull(string[]);
     * </pre>
    ...
    public static String kscToAsc(String str) {
        try {
            ...
            throw new RuntimeException( unknownEncoding, e);
        }
    }
     ...
     * RuntimeException을 발생시킨다. 검증할 문자열 파라미터의 갯수는 제한이 없다.
     * 
     * <pre>
    ...
    public static void verifyStringParameter(String... parameters) {
        ...
        for (String parameter : parameters) {
            if (parameter == null ) {
                ...
                throw new RuntimeException("String parameter is empty");
            }
        }
    }

    /**
     * 입력 객체 값이 null인지 검사한 후 해당 경우 시 RuntimeException을 발생시킨다. 검증할 객체 파라미터의
     * 갯수는 제한이 없다.
     * 
     * <pre>
     ...
     * 원하는 크기가 접미사의 길이보다 작으면 RuntimeException 던진다. 주어진 인코딩 기준으로 byte[]를 얻은 후
    ...
    public static String abbreviate(String content, int maxWidth, String enc, String suffix) {
        ...
        if (maxWidth < suffix.length())
            throw new RuntimeException(illegalArgument, new IllegalArgumentException());
    ...
    public static String parseCurrency(String myString) {
        try {
            ...
            throw new RuntimeException("문자열 파싱에 실패했습니다.",e);
        }
    }
...
//        StringUtil.isEmpty(digit);
    ...
    public static String encode(String string, String fromEncoding, String toEncoding) {
        ...
        try {
            ...
            throw new RuntimeException("StringUtil_FAIL_ENCODING_E");
        }
    }
    ...
    public static String toFormattedString(String string, int patternId) {
        ...
        switch (patternId) {
            ...
            default:
                throw new RuntimeException("StringUtil_NO_FORMAT_E");
        }
    }
    ...
    private static String toFormattedZipCode(String string) {
        ...
        if (string.length() != 6 || !isDigit(string)) {
            throw new RuntimeException("StringUtil_WRONG_ZIP_CODE_E");
        }
    ...
    private static String toFormattedErNo(String string) {
        ...
        if (string.length() != 10 || !isDigit(string)) {
            throw new RuntimeException("StringUtil_WRONG_ER_NO_E");
        }
    ...
    private static String toFormattedTelNo(String string) {
        ...
        if (length < 9 || length > 11 || !isDigit(string)) {
            throw new RuntimeException("StringUtil_WRONG_TEL_NO_E");
        }
    ...
    public static String toFormattedNumber(String digit, String pattern) {
        ...
        try {
            ...
            throw new RuntimeException("StringUtil_WRONG_NUMBER_FORMAT_E");
        }
    }
     ...
     * @return
     */
    public static String lPad(String str, int isize, char cDefault) {
        String retStr = str;
        for (int i = retStr.length(); i < isize; i++) {
            String tmp = String.valueOf(cDefault);
            retStr = tmp + retStr;
        }
        return retStr;
    }    
