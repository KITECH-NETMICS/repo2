...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "LcpMouDomAftrExp")
public class LcpMouDomAftrVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public LcpMouDomAftrVo(){
    }
    ...
    @ElDtoField(logicalName = "occrYmd", physicalName = "occr_ymd", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
