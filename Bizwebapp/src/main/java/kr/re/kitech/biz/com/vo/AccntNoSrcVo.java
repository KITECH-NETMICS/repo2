...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "계정번호 검색")
public class AccntNoSrcVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    ...
    @ElDtoField(logicalName = "계정구분", physicalName = "clsf", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String clsf;
    ...
    @ElDtoField(logicalName = "종료년도", physicalName = "cls_yr", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String cls_yr;
    ...
    @ElDtoField(logicalName = "연구논문", physicalName = "rtpaper", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String rtpaper;
    ...
    @ElDtoField(logicalName = "선행과제검색용 사번", physicalName = "syspayno", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    @ElVoField(physicalName = "cls_yr")
    public String getCls_yr(){
        return cls_yr;
    }

    @ElVoField(physicalName = "cls_yr")
    public void setCls_yr(String cls_yr){
        this.cls_yr = cls_yr;
    }
    ...
    @ElVoField(physicalName = "rtpaper")
    public String getRtpaper(){
        return rtpaper;
    }

    @ElVoField(physicalName = "rtpaper")
    public void setRtpaper(String rtpaper){
        this.rtpaper = rtpaper;
    }
    ...
    public String toString() {
        ...
        sb.append("rtpaper").append("=").append(rtpaper).append(",");
        ...
        sb.append("note_use_ex").append("=").append(note_use_ex);
        sb.append("]");
        return sb.toString();
