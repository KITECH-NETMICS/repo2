...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "PatRegstInsertExp")
public class PatRegstInsertVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
  private static final long serialVersionUID = 1L;

  public PatRegstInsertVo(){
  }
