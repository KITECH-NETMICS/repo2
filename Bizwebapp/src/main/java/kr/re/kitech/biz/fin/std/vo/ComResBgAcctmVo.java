...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "계정번호 공통 Vo")
public class ComResBgAcctmVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public ComResBgAcctmVo(){
    }
