...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "전자세금계산서 품목 Vo")
public class KtxIssuDetailVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public KtxIssuDetailVo(){
    }
    ...
    @ElDtoField(logicalName = "단가", physicalName = "unit_prce", type = "long", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private long unit_prce;
    ...
    @ElDtoField(logicalName = "월", physicalName = "buy_mon", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String buy_mon;

    @ElDtoField(logicalName = "일", physicalName = "buy_day", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    public long getUnit_prce(){
        return unit_prce;
    }

    @ElVoField(physicalName = "unit_prce")
    public void setUnit_prce(long unit_prce){
    ...
    @ElVoField(physicalName = "buy_mon")
    public String getBuy_mon(){
        return buy_mon;
    }

    @ElVoField(physicalName = "buy_mon")
    public void setBuy_mon(String buy_mon){
        this.buy_mon = buy_mon;
    }

    @ElVoField(physicalName = "buy_day")
    ...
    public String toString() {
        ...
        sb.append("buy_mon").append("=").append(buy_mon).append(",");
        sb.append("buy_day").append("=").append(buy_day);
        sb.append("]");
        return sb.toString();
