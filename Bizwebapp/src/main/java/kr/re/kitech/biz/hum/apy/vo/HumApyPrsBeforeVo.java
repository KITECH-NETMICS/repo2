...
public class HumApyPrsBeforeVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public HumApyPrsBeforeVo(){
    }
    ...
    public String toString() {
        ...
        sb.append("respn_clsf_nm").append("=").append(respn_clsf_nm);
        sb.append("]");
        return sb.toString();
