...
@ElDto(FldYn = "Y", delimeterYn = "", logicalName = "사원 List 정보")
public class EmpListVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    ...
    private java.util.List<kr.re.kitech.biz.zam.emp.vo.EmpVo> empVoList;
    ...
    private kr.re.kitech.biz.zam.emp.vo.EmpVo empVo;
    ...
    public java.util.List<kr.re.kitech.biz.zam.emp.vo.EmpVo> getEmpVoList(){
        return empVoList;
    }

    @ElVoField(physicalName = "empVoList")
    public void setEmpVoList(java.util.List<kr.re.kitech.biz.zam.emp.vo.EmpVo> empVoList){
    ...
    public kr.re.kitech.biz.zam.emp.vo.EmpVo getEmpVo(){
        return empVo;
    }

    @ElVoField(physicalName = "empVo")
    public void setEmpVo(kr.re.kitech.biz.zam.emp.vo.EmpVo empVo){
        this.empVo = empVo;
    }
	...
	public byte[] marshalFld(String encode) throws IOException{
        ...
        try {
            ...
            for( int i=0 ; empVoList != null && i < empVoList.size() ; i++ ) {
                kr.re.kitech.biz.zam.emp.vo.EmpVo vo = (kr.re.kitech.biz.zam.emp.vo.EmpVo)empVoList.get(i);
    ...
    public void unMarshalFld( byte[] bytes , String encode) throws ElException{
        try{ 
             ...
             {
                 java.util.List<kr.re.kitech.biz.zam.emp.vo.EmpVo> alList = new java.util.ArrayList<kr.re.kitech.biz.zam.emp.vo.EmpVo>();
                 for( int i=0 ; i < empCnt ; i++ ) {
                     kr.re.kitech.biz.zam.emp.vo.EmpVo vo = new kr.re.kitech.biz.zam.emp.vo.EmpVo(_offset);
