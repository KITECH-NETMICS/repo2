package kr.re.kitech.biz.emp.web;
...
import kr.re.kitech.biz.cmmn.BizUserHeader;
import kr.re.kitech.biz.cmmn.tcp.BizTcpLengthBaseSendUtil;
import kr.re.kitech.biz.emp.service.EmpFileService;
import kr.re.kitech.biz.emp.service.EmpService;
import kr.re.kitech.biz.emp.vo.DeptListVo;
import kr.re.kitech.biz.emp.vo.EmpListVo;
...
public class EmpController {
    ...
    public void login(kr.re.kitech.biz.emp.vo.LoginVo loginVo ,HttpServletRequest request ) throws Exception {
    ...
    public void loginFrm(kr.re.kitech.biz.emp.vo.LoginVo loginVo ,HttpServletRequest request ) throws Exception {    
		String id = loginVo.getId();
