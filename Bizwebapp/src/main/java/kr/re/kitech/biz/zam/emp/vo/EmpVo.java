...
@ElDto(FldYn = "Y", delimeterYn = "", logicalName = "데모 사원 정보")
public class EmpVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    ...
    @ElDtoField(logicalName = "첨부파일번호2", physicalName = "attachFileNo2", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String attachFileNo2;

    @ElDtoField(logicalName = "첨부파일번호3", physicalName = "attachFileNo3", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String attachFileNo3;

    @ElDtoField(logicalName = "첨부파일번호4", physicalName = "attachFileNo4", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String attachFileNo4;

    @ElDtoField(logicalName = "첨부파일번호5", physicalName = "attachFileNo5", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String attachFileNo5;
    ...
    @ElDtoField(logicalName = "입사시작일(검색조건)", physicalName = "fromDate", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String fromDate;

    @ElDtoField(logicalName = "입사종료일(검색조건)", physicalName = "toDate", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String toDate;

    @ElDtoField(logicalName = "사원명(검색조건)", physicalName = "srchWord", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    @ElVoField(physicalName = "attachFileNo2")
    public String getAttachFileNo2(){
        return attachFileNo2;
    }

    @ElVoField(physicalName = "attachFileNo2")
    public void setAttachFileNo2(String attachFileNo2){
        this.attachFileNo2 = attachFileNo2;
    }

    @ElVoField(physicalName = "attachFileNo3")
    public String getAttachFileNo3(){
        return attachFileNo3;
    }

    @ElVoField(physicalName = "attachFileNo3")
    public void setAttachFileNo3(String attachFileNo3){
        this.attachFileNo3 = attachFileNo3;
    }

    @ElVoField(physicalName = "attachFileNo4")
    public String getAttachFileNo4(){
        return attachFileNo4;
    }

    @ElVoField(physicalName = "attachFileNo4")
    public void setAttachFileNo4(String attachFileNo4){
        this.attachFileNo4 = attachFileNo4;
    }

    @ElVoField(physicalName = "attachFileNo5")
    public String getAttachFileNo5(){
        return attachFileNo5;
    }

    @ElVoField(physicalName = "attachFileNo5")
    public void setAttachFileNo5(String attachFileNo5){
    ...
    @ElVoField(physicalName = "fromDate")
    ...
    @ElVoField(physicalName = "srchWord")
    ...
    public String toString() {
        ...
        sb.append("attachFileNo2").append("=").append(attachFileNo2).append(",");
        sb.append("attachFileNo3").append("=").append(attachFileNo3).append(",");
        sb.append("attachFileNo4").append("=").append(attachFileNo4).append(",");
        sb.append("attachFileNo5").append("=").append(attachFileNo5).append(",");
        sb.append("fileName").append("=").append(fileName).append(",");
        sb.append("fileData").append("=").append(fileData).append(",");
        sb.append("inputFileData").append("=").append(inputFileData).append(",");
        sb.append("fromDate").append("=").append(fromDate).append(",");
        sb.append("toDate").append("=").append(toDate).append(",");
        sb.append("srchWord").append("=").append(srchWord).append(",");
