...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "견적서 Vo")
public class PurReqEvalVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    ...
    @ElDtoField(logicalName = "업체명", physicalName = "rcmd_vend", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String rcmd_vend;

    @ElDtoField(logicalName = "추정금액", physicalName = "rcmd_amt", type = "long", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private long rcmd_amt;
    ...
    @ElDtoField(logicalName = "cud 타입", physicalName = "cud_type", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    @ElVoField(physicalName = "rcmd_vend")
    public String getRcmd_vend(){
        return rcmd_vend;
    }

    @ElVoField(physicalName = "rcmd_vend")
    public void setRcmd_vend(String rcmd_vend){
        this.rcmd_vend = rcmd_vend;
    }

    @ElVoField(physicalName = "rcmd_amt")
    public long getRcmd_amt(){
        return rcmd_amt;
    }

    @ElVoField(physicalName = "rcmd_amt")
    public void setRcmd_amt(long rcmd_amt){
        this.rcmd_amt = rcmd_amt;
    }
    ...
    public String toString() {
        ...
        sb.append("PurReqEvalVo [");
        sb.append("pur_req_no").append("=").append(pur_req_no).append(",");
        sb.append("odr").append("=").append(odr).append(",");
        sb.append("rcmd_vend").append("=").append(rcmd_vend).append(",");
        sb.append("rcmd_amt").append("=").append(rcmd_amt).append(",");
