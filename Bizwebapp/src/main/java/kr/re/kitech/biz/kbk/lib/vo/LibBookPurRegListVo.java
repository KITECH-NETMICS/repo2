...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "도서구입신청서팝업리스트VO")
public class LibBookPurRegListVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public LibBookPurRegListVo(){
    }
