...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "연구비입금관리 결의취소 Vo")
public class ResExcSlipCancelVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public ResExcSlipCancelVo(){
    }
