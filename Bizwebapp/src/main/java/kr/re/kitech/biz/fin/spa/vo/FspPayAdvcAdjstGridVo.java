...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "FspPayAdvcAdjstGridExp")
public class FspPayAdvcAdjstGridVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public FspPayAdvcAdjstGridVo(){
    }
    ...
    @ElDtoField(logicalName = "adjstAmt", physicalName = "adjst_amt", type = "long", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    public String toString() {
        ...
        sb.append("FspPayAdvcAdjstGridVo [");
