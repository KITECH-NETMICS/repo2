...
public class SafCheProdDsuseSpaceVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public SafCheProdDsuseSpaceVo(){
    }
    ...
    @ElDtoField(logicalName = "mainSecrtRspnsEmpno", physicalName = "main_secrt_rspns_empno", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String main_secrt_rspns_empno;

    @ElDtoField(logicalName = "mainDeptCd", physicalName = "main_dept_cd", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String main_dept_cd;

    @ElDtoField(logicalName = "mainDeptNewYmd", physicalName = "main_dept_new_ymd", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String main_dept_new_ymd;

    @ElDtoField(logicalName = "mainDeptNm", physicalName = "main_dept_nm", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String main_dept_nm;
    ...
    @ElDtoField(logicalName = "subSecrtRspnsEmpno", physicalName = "sub_secrt_rspns_empno", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String sub_secrt_rspns_empno;
    ...
    @ElDtoField(logicalName = "subDeptCd", physicalName = "sub_dept_cd", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String sub_dept_cd;

    @ElDtoField(logicalName = "subDeptNewYmd", physicalName = "sub_dept_new_ymd", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String sub_dept_new_ymd;

    @ElDtoField(logicalName = "subDeptNm", physicalName = "sub_dept_nm", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    @ElDtoField(logicalName = "labChngRsn", physicalName = "lab_chng_rsn", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String lab_chng_rsn;
    ...
    @ElDtoField(logicalName = "labGubun", physicalName = "lab_gubun", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String lab_gubun;

    @ElDtoField(logicalName = "labNoArr", physicalName = "lab_no_arr", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String lab_no_arr;

    @ElDtoField(logicalName = "labRmkArr", physicalName = "lab_rmk_arr", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String lab_rmk_arr;

    @ElDtoField(logicalName = "mainSecrtRspnsMobile", physicalName = "main_secrt_rspns_mobile", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String main_secrt_rspns_mobile;

    @ElDtoField(logicalName = "subSecrtRspnsMobile", physicalName = "sub_secrt_rspns_mobile", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String sub_secrt_rspns_mobile;
    ...
    @ElVoField(physicalName = "main_secrt_rspns_empno")
    public String getMain_secrt_rspns_empno(){
        return main_secrt_rspns_empno;
    }

    @ElVoField(physicalName = "main_secrt_rspns_empno")
    public void setMain_secrt_rspns_empno(String main_secrt_rspns_empno){
        this.main_secrt_rspns_empno = main_secrt_rspns_empno;
    }

    @ElVoField(physicalName = "main_dept_cd")
    public String getMain_dept_cd(){
        return main_dept_cd;
    }

    @ElVoField(physicalName = "main_dept_cd")
    public void setMain_dept_cd(String main_dept_cd){
        this.main_dept_cd = main_dept_cd;
    }

    @ElVoField(physicalName = "main_dept_new_ymd")
    public String getMain_dept_new_ymd(){
        return main_dept_new_ymd;
    }

    @ElVoField(physicalName = "main_dept_new_ymd")
    public void setMain_dept_new_ymd(String main_dept_new_ymd){
        this.main_dept_new_ymd = main_dept_new_ymd;
    }

    @ElVoField(physicalName = "main_dept_nm")
    public String getMain_dept_nm(){
        return main_dept_nm;
    }

    @ElVoField(physicalName = "main_dept_nm")
    public void setMain_dept_nm(String main_dept_nm){
        this.main_dept_nm = main_dept_nm;
    }
    ...
    @ElVoField(physicalName = "sub_secrt_rspns_empno")
    public String getSub_secrt_rspns_empno(){
        return sub_secrt_rspns_empno;
    }

    @ElVoField(physicalName = "sub_secrt_rspns_empno")
    public void setSub_secrt_rspns_empno(String sub_secrt_rspns_empno){
        this.sub_secrt_rspns_empno = sub_secrt_rspns_empno;
    }
    ...
    @ElVoField(physicalName = "sub_dept_cd")
    ...
    @ElVoField(physicalName = "sub_dept_new_ymd")
    public String getSub_dept_new_ymd(){
        return sub_dept_new_ymd;
    }

    @ElVoField(physicalName = "sub_dept_new_ymd")
    public void setSub_dept_new_ymd(String sub_dept_new_ymd){
        this.sub_dept_new_ymd = sub_dept_new_ymd;
    }

    @ElVoField(physicalName = "sub_dept_nm")
    ...
    @ElVoField(physicalName = "lab_chng_rsn")
    public String getLab_chng_rsn(){
        return lab_chng_rsn;
    }

    @ElVoField(physicalName = "lab_chng_rsn")
    public void setLab_chng_rsn(String lab_chng_rsn){
        this.lab_chng_rsn = lab_chng_rsn;
    }
    ...
    @ElVoField(physicalName = "lab_gubun")
    public String getLab_gubun(){
        return lab_gubun;
    }

    @ElVoField(physicalName = "lab_gubun")
    public void setLab_gubun(String lab_gubun){
        this.lab_gubun = lab_gubun;
    }

    @ElVoField(physicalName = "lab_no_arr")
    public String getLab_no_arr(){
        return lab_no_arr;
    }

    @ElVoField(physicalName = "lab_no_arr")
    public void setLab_no_arr(String lab_no_arr){
        this.lab_no_arr = lab_no_arr;
    }

    @ElVoField(physicalName = "lab_rmk_arr")
    public String getLab_rmk_arr(){
        return lab_rmk_arr;
    }

    @ElVoField(physicalName = "lab_rmk_arr")
    public void setLab_rmk_arr(String lab_rmk_arr){
        this.lab_rmk_arr = lab_rmk_arr;
    }

    @ElVoField(physicalName = "main_secrt_rspns_mobile")
    public String getMain_secrt_rspns_mobile(){
        return main_secrt_rspns_mobile;
    }

    @ElVoField(physicalName = "main_secrt_rspns_mobile")
    public void setMain_secrt_rspns_mobile(String main_secrt_rspns_mobile){
        this.main_secrt_rspns_mobile = main_secrt_rspns_mobile;
    }

    @ElVoField(physicalName = "sub_secrt_rspns_mobile")
    public String getSub_secrt_rspns_mobile(){
        return sub_secrt_rspns_mobile;
    }

    @ElVoField(physicalName = "sub_secrt_rspns_mobile")
    public void setSub_secrt_rspns_mobile(String sub_secrt_rspns_mobile){
        this.sub_secrt_rspns_mobile = sub_secrt_rspns_mobile;
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("SafCheProdDeuseSpaceVo [");
        ...
        sb.append("main_secrt_rspns_empno").append("=").append(main_secrt_rspns_empno).append(",");
        sb.append("main_dept_cd").append("=").append(main_dept_cd).append(",");
        sb.append("main_dept_new_ymd").append("=").append(main_dept_new_ymd).append(",");
        sb.append("main_dept_nm").append("=").append(main_dept_nm).append(",");
        ...
        sb.append("sub_secrt_rspns_empno").append("=").append(sub_secrt_rspns_empno).append(",");
        sb.append("sub_secrt_rspns_ymd").append("=").append(sub_secrt_rspns_ymd).append(",");
        sb.append("sub_dept_cd").append("=").append(sub_dept_cd).append(",");
        sb.append("sub_dept_new_ymd").append("=").append(sub_dept_new_ymd).append(",");
        sb.append("sub_dept_nm").append("=").append(sub_dept_nm).append(",");
        ...
        sb.append("user_count").append("=").append(user_count).append(",");
        sb.append("lab_no").append("=").append(lab_no).append(",");
        sb.append("lab_chng_rsn").append("=").append(lab_chng_rsn).append(",");
        sb.append("address").append("=").append(address).append(",");
        sb.append("lab_gubun").append("=").append(lab_gubun).append(",");
        sb.append("lab_no_arr").append("=").append(lab_no_arr).append(",");
        sb.append("lab_rmk_arr").append("=").append(lab_rmk_arr).append(",");
        sb.append("main_secrt_rspns_mobile").append("=").append(main_secrt_rspns_mobile).append(",");
        sb.append("sub_secrt_rspns_mobile").append("=").append(sub_secrt_rspns_mobile);
        sb.append("]");
        return sb.toString();
