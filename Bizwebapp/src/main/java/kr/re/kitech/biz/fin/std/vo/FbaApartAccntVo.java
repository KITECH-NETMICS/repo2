...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "별도계좌 Vo")
public class FbaApartAccntVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public FbaApartAccntVo(){
    }
