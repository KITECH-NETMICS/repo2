...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "경조사비 등록")
public class CcsCwlSvCgCdVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public CcsCwlSvCgCdVo(){
    }
    ...
    @ElDtoField(logicalName = "예금은행코드", physicalName = "depst_bank_cd", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    @ElDtoField(logicalName = "반려사유", physicalName = "reject_resn", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String reject_resn;

    @ElDtoField(logicalName = "apr_state_code", physicalName = "apr_state_code", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    public String toString() {
        ...
        sb.append("apr_state_code").append("=").append(apr_state_code);
        sb.append("]");
        return sb.toString();
