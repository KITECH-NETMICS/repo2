...
public class ImgPaginationRenderer extends AbstractPaginationRenderer {
    ...
    /**
    * 페이지 처리의 링크에 해당하는 Renderer
    */
	public ImgPaginationRenderer() {

		//String strWebDir = "/egovframework.guideprogram.basic/cm/images/zam/cmmn/"; // localhost
		String strWebDir = "/BizWebApp/cm/images/zam/el/";
