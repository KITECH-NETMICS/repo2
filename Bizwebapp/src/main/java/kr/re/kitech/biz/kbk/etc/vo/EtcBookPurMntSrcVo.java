...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "도서구입관리조회VO")
public class EtcBookPurMntSrcVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public EtcBookPurMntSrcVo(){
    }
