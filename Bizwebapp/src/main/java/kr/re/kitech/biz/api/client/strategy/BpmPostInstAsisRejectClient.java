 ...
 * @since 2022. 5. 3.
 */
@Component("bpmPostInstAsisReject")
@Scope(value = "prototype", proxyMode = ScopedProxyMode.TARGET_CLASS)
public class BpmPostInstAsisRejectClient implements BpmClient {
	public static String SERVICE= "/rest/bpm/process-instances/asis/complete/reject";
	...
	public String makeEndPoint(BpmRequest req){
		return this.baseUrl + SERVICE + "?instanceId="+req.getInstanceId()+"&instName="+req.getInstName();
	}
