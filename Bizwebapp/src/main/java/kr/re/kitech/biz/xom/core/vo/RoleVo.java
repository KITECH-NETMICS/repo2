...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "권한 관리 롤 Vo")
public class RoleVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    ...
    @ElDtoField(logicalName = "롤 레벨", physicalName = "roleLevel", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    @ElDtoField(logicalName = "롤명", physicalName = "cnRoleFullName", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String cnRoleFullName;

    @ElDtoField(logicalName = "parentGroupCode", physicalName = "parentGroupCode", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String parentGroupCode;

    @ElDtoField(logicalName = "롤순서", physicalName = "roleOrder", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    @ElDtoField(logicalName = "롤이름", physicalName = "roleName", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
