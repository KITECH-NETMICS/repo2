 ...
 * @since 2022. 5. 3.
 */
@Component("bpmPostInst")
@Scope(value = "prototype", proxyMode = ScopedProxyMode.TARGET_CLASS)
public class BpmPostInstClient implements BpmClient {
	public static String SERVICE= "/rest/bpm/process-instances/{serviceType}";
	...
	public String makeEndPoint(BpmRequest req){
		...
		builder.setPathSegment( ArrayUtils.indexOf(template.pathSegments().toArray(), "{serviceType}"), req.getServiceType().getCode());
		return builder.build().toString();
	}

	/* (non-Javadoc)
	 * @see kr.re.kitech.biz.api.client.BpmClient#buildBody(kr.re.kitech.biz.api.client.model.BpmRequest)
	 */
	@Override 
