package kr.re.kitech.biz.hum.tax.service.impl;
...
import kr.re.kitech.biz.hum.tax.dao.HumTaxPayDAO;
 ...
 * 
 */
@Service("humTaxPayServiceImpl")
public class HumTaxPayServiceImpl  extends EgovAbstractServiceImpl implements HumTaxPayService {
  @Resource(name="humTaxPayDAO") 
  private HumTaxPayDAO taxDAO;
 ...
 /**
  ...
  public List<HumTaxPayVo> selectTaxPayInfoList(HumTaxPayVo vo)  throws KitechException {
    return taxDAO.selectTaxPayInfoList(vo);	     
  }
  ...
  public List<HumTaxPayVo> selectHumTaxPayInfoList(HumTaxPayVo vo)  throws KitechException {
    return taxDAO.selectHumTaxPayInfoList(vo);	     
  }
}
