 ...
 * @since 2022. 5. 3.
 */
@Service("csrCntClient")
@Scope(value = "prototype", proxyMode = ScopedProxyMode.TARGET_CLASS)
public class CsrCntClient implements CsrClient {
	public static String CNT_SERVICE = "/rest/v1/wf/count/";
	...
	public String makeEndPoint(CsrVo csr){
		return this.baseUrl + CNT_SERVICE + csr.getUserLoginId();
	}
