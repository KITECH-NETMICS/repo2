...
public class KbkPopBookDetailVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public KbkPopBookDetailVo(){
    }
    ...
    @ElDtoField(logicalName = "checkup_req_no", physicalName = "checkup_req_no", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String checkup_req_no;

    @ElDtoField(logicalName = "contrct_nm", physicalName = "contrct_nm", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
