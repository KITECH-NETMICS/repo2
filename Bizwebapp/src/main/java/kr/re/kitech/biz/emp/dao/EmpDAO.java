package kr.re.kitech.biz.emp.dao;
...
import kr.re.kitech.biz.cmmn.dao.BizDefaultAbstractDAO;
import kr.re.kitech.biz.emp.vo.DeptVo;
...
public class EmpDAO extends BizDefaultAbstractDAO {
    ...
    public int insertEmp(EmpVo vo) throws ElException {
        return insert("kr.re.kitech.biz.emp.insertEmp", vo);
    }

    public int updateEmp(EmpVo vo) throws ElException {
        return update("kr.re.kitech.biz.emp.updateEmp", vo);
    }

    public int deleteEmp(EmpVo vo) throws ElException {
    	return delete("kr.re.kitech.biz.emp.deleteEmp", vo);
    }

    public EmpVo selectEmp(EmpVo vo) throws ElException {
 
        return (EmpVo) selectByPk("kr.re.kitech.biz.emp.selectEmp", vo);
    }

    public List<EmpVo> selectListEmp(EmpVo vo) throws ElException {
    	AppLog.debug("DAO 에서 로그 테스트");

        return list("kr.re.kitech.biz.emp.selectListEmp", vo);
    }

    public long selectListCountEmp(EmpVo vo)  throws ElException{
        return (Long)selectByPk("kr.re.kitech.biz.emp.selectListCountEmp", vo);
    }

    public ArrayList<DeptVo> selectListDept(HashMap searchKeyHm) throws ElException {
    	return (ArrayList<DeptVo>)list("kr.re.kitech.biz.emp.selectListDept", searchKeyHm);
    }
