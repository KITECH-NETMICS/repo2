...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "AssUnUseMastExp")
public class AssUnUseMastVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public AssUnUseMastVo(){
    }
    ...
    @ElDtoField(logicalName = "depthed_nm", physicalName = "depthed_nm", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
