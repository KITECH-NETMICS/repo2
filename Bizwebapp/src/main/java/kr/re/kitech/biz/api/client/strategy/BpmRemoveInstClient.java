...
/**
 * BPM 결재리스트를 다건 조회 API 연계 클라이언트 구현체.
 *
 * @author James
 * @since 2022. 5. 20.
 */
@Component("bpmRemoveInst")
@Scope(value = "prototype", proxyMode = ScopedProxyMode.TARGET_CLASS)
public class BpmRemoveInstClient implements BpmClient {
	public static String SERVICE = "/rest/bpm/process-instances/remove/{instanceid}";
	...
	public String makeEndPoint(BpmRequest req){
		...
		builder.setPathSegment( ArrayUtils.indexOf(template.pathSegments().toArray(), "{instanceid}"), req.getInstName());
