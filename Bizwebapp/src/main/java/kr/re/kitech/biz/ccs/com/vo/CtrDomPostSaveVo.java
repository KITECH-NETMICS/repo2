...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "국내출장신청및 정산 결재후 저장 VO")
public class CtrDomPostSaveVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public CtrDomPostSaveVo(){
    }
