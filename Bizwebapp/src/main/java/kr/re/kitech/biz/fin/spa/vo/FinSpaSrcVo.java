...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "근거리출장결의 조회 Vo")
public class FinSpaSrcVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    ...
    @ElDtoField(logicalName = "결의여부", physicalName = "slip_chk", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String slip_chk;

    @ElDtoField(logicalName = "통제여부", physicalName = "ctrl_gb", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    @ElVoField(physicalName = "ctrl_gb")
    public String getCtrl_gb(){
        return ctrl_gb;
    }

    @ElVoField(physicalName = "ctrl_gb")
    public void setCtrl_gb(String ctrl_gb){
        this.ctrl_gb = ctrl_gb;
    }
    ...
    public String toString() {
        ...
        sb.append("ctrl_gb").append("=").append(ctrl_gb).append(",");
