...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "PatPexReqInvExp")
public class PatPexReqInvVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public PatPexReqInvVo(){
    }
    ...
    @ElDtoField(logicalName = "askPsnSyspaynm", physicalName = "ask_psn_syspaynm", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String ask_psn_syspaynm;

    @ElDtoField(logicalName = "askDaytm", physicalName = "ask_daytm", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String ask_daytm;

    @ElDtoField(logicalName = "askComment", physicalName = "ask_comment", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String ask_comment;

    @ElDtoField(logicalName = "askAttachFile", physicalName = "ask_attach_file", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String ask_attach_file;
    ...
    @ElVoField(physicalName = "ask_psn_syspaynm")
    public String getAsk_psn_syspaynm(){
        return ask_psn_syspaynm;
    }

    @ElVoField(physicalName = "ask_psn_syspaynm")
    public void setAsk_psn_syspaynm(String ask_psn_syspaynm){
        this.ask_psn_syspaynm = ask_psn_syspaynm;
    }

    @ElVoField(physicalName = "ask_daytm")
    public String getAsk_daytm(){
        return ask_daytm;
    }

    @ElVoField(physicalName = "ask_daytm")
    public void setAsk_daytm(String ask_daytm){
        this.ask_daytm = ask_daytm;
    }

    @ElVoField(physicalName = "ask_comment")
    ...
    @ElVoField(physicalName = "ask_attach_file")
    public String getAsk_attach_file(){
        return ask_attach_file;
    }

    @ElVoField(physicalName = "ask_attach_file")
    public void setAsk_attach_file(String ask_attach_file){
        this.ask_attach_file = ask_attach_file;
    }
    ...
    public String toString() {
        ...
        sb.append("PatPexReqInvVo [");
        sb.append("demnd_id").append("=").append(demnd_id).append(",");
        sb.append("job_state_cd").append("=").append(job_state_cd).append(",");
        sb.append("ask_psn_syspaynm").append("=").append(ask_psn_syspaynm).append(",");
        sb.append("ask_daytm").append("=").append(ask_daytm).append(",");
        sb.append("ask_comment").append("=").append(ask_comment).append(",");
        sb.append("ask_attach_file").append("=").append(ask_attach_file).append(",");
