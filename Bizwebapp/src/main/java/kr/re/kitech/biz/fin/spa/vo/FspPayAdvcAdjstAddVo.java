...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "FspPayAdvcAdjstAddExp")
public class FspPayAdvcAdjstAddVo extends kr.re.kitech.biz.fin.com.vo.BblenfrcVo {
    private static final long serialVersionUID = 1L;

    public FspPayAdvcAdjstAddVo(){
    }
    ...
    @ElDtoField(logicalName = "adjstReqOdr", physicalName = "adjst_req_odr", type = "int", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private int adjst_req_odr;
    ...
    @ElDtoField(logicalName = "accntRspnsEmpno", physicalName = "accnt_rspns_empno", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    @ElDtoField(logicalName = "adjstAmt", physicalName = "adjst_amt", type = "int", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private int adjst_amt;
    ...
    @ElDtoField(logicalName = "depstrNm", physicalName = "depstr_nm", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    public int getAdjst_req_odr(){
        return adjst_req_odr;
    }

    @ElVoField(physicalName = "adjst_req_odr")
    public void setAdjst_req_odr(int adjst_req_odr){
    ...
    public int getAdjst_amt(){
        return adjst_amt;
    }

    @ElVoField(physicalName = "adjst_amt")
    public void setAdjst_amt(int adjst_amt){
    ...
    public String toString() {
        ...
        sb.append("FspPayAdvcAdjstAddVo [");
        ...
        sb.append("bugt_item_cd").append("=").append(bugt_item_cd);
        sb.append("]");
        return sb.toString();
