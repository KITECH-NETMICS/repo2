...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "연구비청구결의 Vo")
public class ResDemndSlipVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public ResDemndSlipVo(){
    }
    ...
    @ElDtoField(logicalName = "거래처코드", physicalName = "depst_loc", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    @ElDtoField(logicalName = "청구구분", physicalName = "depst_clsf", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
