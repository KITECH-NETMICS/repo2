...
public class AppLineInfo implements Serializable
{
    ...
    private final static long serialVersionUID = -83648059595532969L;
    ...
    public AppLineInfo withTrcTag(String trcTag) {
        this.trcTag = trcTag;
        return this;
    }
    ...
    public AppLineInfo withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public AppLineInfo withApprEditable(Boolean apprEditable) {
        this.apprEditable = apprEditable;
        return this;
    }
    ...
    public AppLineInfo withName(Object name) {
        this.name = name;
        return this;
    }
    ...
    public AppLineInfo withLinetype(String linetype) {
        this.linetype = linetype;
        return this;
    }
    ...
    public AppLineInfo withExtApprId1(Object extApprId1) {
        this.extApprId1 = extApprId1;
        return this;
    }
    ...
    public AppLineInfo withApprovalLineInfos(List<ApprovalLineInfo> approvalLineInfos) {
        this.approvalLineInfos = approvalLineInfos;
        return this;
    }
    ...
    public AppLineInfo withWorklineinfos(List<Worklineinfo> worklineinfos) {
        this.worklineinfos = worklineinfos;
        return this;
    }
    ...
    public AppLineInfo withWorkInfos(List<WorkInfo> workInfos) {
        this.workInfos = workInfos;
        return this;
    }
    ...
    public AppLineInfo withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AppLineInfo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("trcTag");
        sb.append('=');
