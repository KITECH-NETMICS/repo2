...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "휴가신청VO")
public class ApiEipVacaReqVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public ApiEipVacaReqVo(){
    }
