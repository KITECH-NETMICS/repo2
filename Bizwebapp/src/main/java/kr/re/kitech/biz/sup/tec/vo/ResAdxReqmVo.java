...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "경상비지원 Vo")
public class ResAdxReqmVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    ...
    public String toString() {
        ...
        sb.append("divsn_clsf").append("=").append(divsn_clsf);
        sb.append("]");
        return sb.toString();
