...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "학생연구원활용예정확인서 조회조건")
public class HumApyStuSrchVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public HumApyStuSrchVo(){
    }
