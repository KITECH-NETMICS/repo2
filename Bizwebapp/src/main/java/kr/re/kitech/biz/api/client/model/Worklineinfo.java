...
public class Worklineinfo implements Serializable
{
    ...
    public Worklineinfo withTrcTag(String trcTag) {
        this.trcTag = trcTag;
        return this;
    }
    ...
    public Worklineinfo withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Worklineinfo withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public Worklineinfo withScrUrl(String scrUrl) {
        this.scrUrl = scrUrl;
        return this;
    }
    ...
    public Worklineinfo withExt2(String ext2) {
        this.ext2 = ext2;
        return this;
    }
    ...
    public Worklineinfo withArbitraryApprovable(Boolean arbitraryApprovable) {
        this.arbitraryApprovable = arbitraryApprovable;
        return this;
    }
    ...
    public Worklineinfo withApprType(String apprType) {
        this.apprType = apprType;
        return this;
    }
    ...
    public Worklineinfo withRole(Role role) {
        this.role = role;
        return this;
    }
    ...
    public Worklineinfo withAutoApproval(String autoApproval) {
        this.autoApproval = autoApproval;
        return this;
    }
    ...
    public Worklineinfo withEndTime(String endTime) {
        this.endTime = endTime;
        return this;
    }
    ...
    public Worklineinfo withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Worklineinfo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("trcTag");
        sb.append('=');
