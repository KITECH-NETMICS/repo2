...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "LcpEventExpnsExp")
public class LcpEventExpnsVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public LcpEventExpnsVo(){
    }
    ...
    @ElDtoField(logicalName = "decsnSlipNo", physicalName = "decsn_slip_no", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
