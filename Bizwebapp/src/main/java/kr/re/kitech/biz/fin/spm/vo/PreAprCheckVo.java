...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "결재신청시 체크 Vo")
public class PreAprCheckVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public PreAprCheckVo(){
    }
    ...
    @ElDtoField(logicalName = "체크YN", physicalName = "chk_yn", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String chk_yn;

    @ElDtoField(logicalName = "체크개수", physicalName = "chk_cnt", type = "int", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private int chk_cnt;

    @ElDtoField(logicalName = "리턴메시지", physicalName = "rtn_msg", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    @ElVoField(physicalName = "chk_cnt")
    ...
    @ElVoField(physicalName = "rtn_msg")
    ...
    public String toString() {
        ...
        sb.append("chk_yn").append("=").append(chk_yn).append(",");
        sb.append("chk_cnt").append("=").append(chk_cnt).append(",");
        sb.append("rtn_msg").append("=").append(rtn_msg);
        sb.append("]");
        return sb.toString();
