...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "자산 이동신청  VO")
public class AssAppMoveReqVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    private static final long serialVersionUID = 1L;

    public AssAppMoveReqVo(){
    }
    ...
    @ElDtoField(logicalName = "", physicalName = "save_clsf", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    public String toString() {
        ...
        sb.append("save_clsf").append("=").append(save_clsf);
        sb.append("]");
        return sb.toString();
