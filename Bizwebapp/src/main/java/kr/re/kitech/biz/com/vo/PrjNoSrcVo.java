...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "과제정보 팝업 조회 Vo")
public class PrjNoSrcVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    ...
    @ElDtoField(logicalName = "장비구분", physicalName = "equip_clsf", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    private String equip_clsf;

    @ElDtoField(logicalName = "순번", physicalName = "equip_odr", type = "String", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
    ...
    public String toString() {
        ...
        sb.append("equip_odr").append("=").append(equip_odr);
        sb.append("]");
        return sb.toString();
