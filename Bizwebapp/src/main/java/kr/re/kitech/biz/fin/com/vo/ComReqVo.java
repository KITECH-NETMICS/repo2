...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "신청서공통Vo(ResEquipFeeReqVo에서 사용)")
public class ComReqVo extends kr.re.kitech.biz.xom.base.model.BizCommVO {
    ...
    @ElDtoField(logicalName = "신청금액(자동결의에서 필요)", physicalName = "req_amt", type = "long", typeKind = "", fldYn = "", delimeterYn = "", cryptoGbn = "", cryptoKind = "", length = 0, dotLen = 0, baseValue = "", desc = "")
